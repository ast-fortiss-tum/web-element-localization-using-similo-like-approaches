...
}
{
    ...
    ebayContent["GlobalHeaderWeb/GHJavascriptContent"] = {
        ...
        signinURL: '<a href="https://web.archive.org/web/20180901101317/https://signin.ebay.com/ws/eBayISAPI.dll?SignIn"></a>',
        errL10n: "Sorry, this feature is currently not supported on this page",
        roverurl: '<a href="https://web.archive.org/web/20180901101317/http://rover.ebay.com"></a>',
            ...
            GH = {
                ...
                init: function () {
                    ...
                    var e = function (a) {
                        ...
                        for (b in GH.CompConstructors) if (GH[b] && "function" === typeof GH[b].init) try {
                            GH[b].init()
                        } catch (a) {
    ...
    (function (c) {
        GH.add("Util", function () {
            var k, o, r = GH.L10N, t = GH.GHSW, s = GH.isDefined, u = GH.sec, q = {}, p;
            ...
            return {
                sec: u, geo: !1, getPageID: function () {
                    return GH.C.pageId
                },
                getSiteID: function () {
                    return GH.C.siteId
                    ...
                    if (2046732 == o || 2045573 == o || 2334524 == o) {
                        var a = c(GH.SearchBox.formID + " input[name=LH_TitleDesc]"),
                            b = window.location.href, d = c("#gh-as-a"), g, f, h;
                ...
                getBundle: function (a) {
                    ...
                    GH.Util.closeOverlay(c("#gh-ug, #gf-fbtn, .gh-dd .gh-control," + (GH.ShopByCat ||
                        {}).controlID));
                    ...
                    GH.Geo && GH.Geo.hideMsgOverlay()
                                        ...
                                        b) {
                    var d = "#gh-eb-" + a, g = c(d + " .gh-eb-li-a").outerWidth() - 8;
                    GH.Util.hideOverlays();
                    ...
                    var g = "#gh-eb-" + a, f = c(g + " .gh-eb-li-a").outerWidth() - 8;
                    GH.Util.hideOverlays();
                    ...
                    d && (c = "");
                    d = RegExp(c + "http:");
                    GH.sec && (a = a.replace(d, "https:"), b && (b = RegExp(c + "https://web.archive.org/web/20180901101317/https://ir."), c = RegExp(c + "https://web.archive.org/web/20180901101317/https://pics."), a = a.replace(b, "https://web.archive.org/web/20180901101317/https://secureir."), a = a.replace(c, "https://web.archive.org/web/20180901101317/https://securepics.")));
                    return a
                }, addPrefixPoolURL: function (a) {
                    var b =
                            GH.GHSW.pool ? GH.GHSW.pool : null, d = c.isArray(a), g = "string" === typeof a,
                        f = [0, 31, 215, 248], h = GH.siteSpecific.maprules.regex,
                    ...
                    var b = "", d, c, f, h, l, j = 0, n = a.length;
                ...
                tabHidden: function (a) {
                    ...
                    var a = GH, b = {
                            COOKIELET_DELIMITER: "^",
                            NAME_VALUE_DELIMITER: "/", escapedValue: !0
                        }, c = {COOKIELET_DELIMITER: "^", NAME_VALUE_DELIMITER: "/", bUseExp: !0, startDelim: "b"},
                        g = {COOKIELET_DELIMITER: "^", NAME_VALUE_DELIMITER: "=", escapedValue: !0, startDelim: "^"},
                        f = {
                            reg: ["dp1", "reg"],
                            recent_vi: ["ebay", "lvmn"],
                            ebaysignin: ["ebay", "sin"],
                    ...
                    a.vCJar = {
                        readCookie: function (a, n) {
                            ...
                            var e = n && n.match(/guid$/), c = "undefined" != typeof b ? b : "";
                            ...
                            if (a && void 0 !== b && (isNaN(b) && 4E3 > b.length || 4E3 > (b + "").length)) {
                                ...
                                var e = c ? new Date(c) : new Date(this.getExpDate(730)), m = this.getFormat(a);
                            ...
                            if (null != a && 0 < a.length && "#" == a.charAt(0)) {
                                var c = b % 4, e = a.length - (Math.floor(b / 4) + 1),
                                    e = parseInt(a.substring(e, e + 1), 16), c = 1 << c;
                                return (e & c) == c ? 1 : 0
                            }
                            return this.getBitFlagOldVersion(a, b)
                                                 ...
                                                 b, c) {
                            if (null != a && 0 < a.length && "#" == a.charAt(0)) {
                                var e = a.length, m = b % 4, b = Math.floor(b / 4) + 1;
                                if (e <= b) {
                                    if (1 != c) return a;
                            ...
                            var e = f[a], d = this.getFormat(a), g = this.getMode(a),
                            ...
                            for (var b = /^"(.*)"$/, c = 0; c < a.length; c++) {
                                var e = a[c].split("="), d = this.getFormat(e[0]), f = e[1];
                            ...
                            if (0 === b) return "00";
                            if (b && "0" != b) {
                                if (-1 != b.indexOf(".")) for (var e = b.split("."), b = 0; b < e.length; b++) c = parseInt(e[b], 16).toString(2) + c; else c = parseInt(b, 16).toString(2);
                                var b = 0, e = c.length, d, g;
                                for (g in f) {
                                    d = e - 2 * (b + 1);
                        ...
                        getMulti: function (a, b, c) {
                            ...
                            var f = 0, g, d = d.toString(2).substring(0, c);
                            g = d.length;
                            if (g < c) {
                                c -= g;
                                for (f = 0; f < c; f++) d = "0" + d;
                    ...
                    if (GH.oldDT && !s("noStandardCSS")) {
                        ...
                        a = (k.sec ? "https://web.archive.org/web/20180901101317/https://secureinclude" : "https://web.archive.org/web/20180901101317/http://include") + ".ebaystatic.com/css/v/us/legacy/" + a + ".css";
                        c.getCSS(a)
                    }
                    ...
                    c.fn.scrollLock = function (a) {
                        if (c.isFunction(c.fn.on)) return c(this).on("DOMMouseScroll." + a + " mousewheel." + a, function (a) {
                            var d = c(this), g = this.scrollTop, f = this.scrollHeight, h = d.height(),
                    ...
                    c.fn.ghellipsis = function (a) {
                        ...
                        this.each(function () {
                            var b = c(this), d = b.text(), g = b.height();
                            if (!b.hasClass("ghellip")) {
                                b.addClass("ghellip");
                                b.text("a");
                                var f = parseFloat(b.css("lineHeight"), 10), h = b.height(),
                    ...
                    c.fn.hoverIntent = function (a, b) {
                        var d, g, f, h, l = function (a) {
                            d = a.pageX;
                            g = a.pageY
                        }, j = {sensitivity: 15, interval: 100, timeout: 150}, n = function (a, b) {
        ...
        GH.add("TopBar", function () {
            ...
            return {
                addCSSShadow: function () {
                    a("#gh-gb").addClass("gh-gb-shadow")
                }, removeCSSShadow: function () {
                    c && a("#gh-gb").removeClass("gh-gb-shadow")
                }, init: function () {
                    var d = document.body.style, e = window.getComputedStyle, b;
                    a(GH.componentID).removeClass("gh-pre-js");
                    e && d && (c = !0, b = e(document.body), d.backgroundImage = "url('data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAAKCAYAAAB10jRKAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAADBJREFUeNpEyqERADAIBMGbbwSH+qhA/6URXMyqBUhFBLIP6ip0ezk2zExqC58nwACVZwX67tO41gAAAABJRU5ErkJggg==')," +
                        (b.backgroundImage || ""), document.body.style.backgroundRepeat = "repeat-x," + (b.backgroundRepeat || ""), document.body.style.backgroundPosition = "0 30px," + (b.backgroundPosition || ""));
                    a("body").prepend("<div id=gh-gb tabindex='-1' " + (!b || a("body.RTMPushdown").length ? "class='gh-gb-shadow'" : "") + "></div>")
                }
            }
        })
    })(GH.jQ);
    ...
    ebayContent["GlobalHeaderWeb/FooterJavascriptContent"] = {mftrLinkURL: '<a href="https://web.archive.org/web/20180901101317/http://www.m.ebay.com"></a>'};
    (function (a) {
            ...
            return {
                init: function () {
                    ...
                    !e.hideMobile && (GH.userAgent.match(/android.*mobile|bntv|blackberry|bb10|webos|iemobile|silk|cloud9|iphone/i) &&
                        !GH.userAgent.match(/kindle|Nexus 7|NOOK|BNTV/i)) && a.cachedScript(GH.Util.getSecURL("https://web.archive.org/web/20180901101317/http://ir.ebaystatic.com/f/logwisyb5e5yddn4zmlg5mnhbab.js", !0));
        ...
        GH.add("ShopByCat", function () {
            ...
            return {
                controlID: "#gh-shop-a", init: function () {
                    ...
                    a("#gh-shop").bind("focusout", function (h) {
                        !(0 < a(h.target).closest("#gh-shop").length) && f() && (GH.Util.toggleOverlay(a(b.controlID)), a("#gh-shop").toggleClass("gh-shop-active"))
                    })
                }, assignControlClickHandler: function (h) {
                    a(h).click(function (h, g) {
                        (!f() || a("#gh-sbc-o").is(":hidden")) && GH.Util.hideOverlays();
                        0 < a(h.target).closest("#gh-sbc-o").length || (f() ? (GH.Util.toggleOverlay(a(b.controlID)), a("#gh-shop").toggleClass("gh-shop-active"), a("#gh-sbc-o").is(":hidden") || (GH.Util.cTImg(GH.ghiIMP + 34), setTimeout(function () {
                            ...
                            a("#gh-sbc-o a:first").focus()
                        }, 100), g && a("#gh-sbc-o a:first").focus()), h.preventDefault())
                    })
                }, buildOverlayHTML: function () {
                    var a = ['<table id="gh-sbc"><tbody><tr>'], b = 0, g, f = [];
                    GH.getShopByCatData && (g = GH.getShopByCatData(), f = GH.Util.addPrefixPoolURL(g.data), g = g.itemsPerColumn ||
                        3);
                    for (var m = 0, o = f.length; m < o; m++) {
                        var k = f[m], c = k.parent, i = c.id, j = c.title || "", d = c.url || "javascript:;", l = c.txt,
                            e = c.sp ? "_sp=" + c.sp : "", n = c.id ? "id=" + c.id : "";
                        0 < d.indexOf("/sch/allcategories/all-categories") || 0 < d.indexOf("immo.ebay.be/fr/") || (d = GH.Util.getHTTPSURL(d));
                        if (i && ("gh-shop-col-link" == i || "gh-shop-see-all" == i)) a.push('<h3 class="gh-sbc-parent"><a title="' + j + '" href="' + d + '" ' + e + " " + n + ">" + l + '<i class="gh-sbc-h3i gh-sprRetina"></i></a></h3>'); else {
                            0 == b % g && (i = "</td><td>", 0 == b && (i = "<td>"), a.push(i));
                            a.push('<h3 class="gh-sbc-parent">' + (c.url ? '<a title="' + j + '" href="' + d + '" ' + e + " " + n + ">" + l + '<i class="gh-sbc-h3i gh-sprRetina"></i></a>' : l) + "</h3>");
    ...
    GH.getShopByCatData = function () {
        return {
            data: [{
                parent: {
                    sp: "m570.l3410",
                    url: "https://web.archive.org/web/20180901101317/http://www.ebay.com/rpp/collectibles-art",
                    txt: "Collectibles & art"
                },
                children: [{
                    sp: "m570.l3638",
                    url: "https://web.archive.org/web/20180901101317/http://www.ebay.com/rpp/collectibles",
                    txt: "Collectibles"
                }, {
                    sp: "m570.l3637",
                    url: "https://web.archive.org/web/20180901101317/http://www.ebay.com/rpp/coins",
                    txt: "Coins & paper money"
                }, {
                    sp: "m570.l3636",
                    url: "https://web.archive.org/web/20180901101317/http://www.ebay.com/rpp/antiques",
                    txt: "Antiques"
                }, {
                    sp: "m570.l3639",
                    url: "https://web.archive.org/web/20180901101317/http://www.ebay.com/rpp/sports-mem",
                ...
                parent: {
                    ...
                    sp: "m570.l3413",
                    url: "https://web.archive.org/web/20180901101317/http://www.ebay.com/rpp/electronics",
                    txt: "Electronics"
                },
                children: [{
                    sp: "m570.l3653",
                    url: "https://web.archive.org/web/20180901101317/http://www.ebay.com/rpp/computers-networking",
                    txt: "Computers & tablets"
                }, {
                    sp: "m570.l3654",
                    url: "https://web.archive.org/web/20180901101317/http://www.ebay.com/rpp/camera-photo",
                    txt: "Cameras & photo"
                }, {
                    sp: "m570.l3655",
                    url: "https://web.archive.org/web/20180901101317/http://www.ebay.com/rpp/tv-video-audio",
                    txt: "TV, audio & surveillance"
                }, {
                    sp: "m570.l3652",
                    url: "https://web.archive.org/web/20180901101317/http://www.ebay.com/rpp/cell-phone-pda",
                    txt: "Cell phones & accessories"
                }]
            }, {
                parent: {
                    sp: "m570.l3649",
                    url: "https://web.archive.org/web/20180901101317/http://www.ebay.com/rpp/entertainment-memorabilia",
                    txt: "Entertainment memorabilia"
                },
                children: [{
                    sp: "m570.l3275",
                    url: "https://web.archive.org/web/20180901101317/http://www.ebay.com/rpp/video-games",
                    txt: "Video games & consoles"
                }, {
                    sp: "m570.l3771",
                    url: "https://web.archive.org/web/20180901101317/http://www.ebay.com/rpp/music",
                    txt: "Music"
                }, {
                    sp: "m570.l4133",
                    url: "https://web.archive.org/web/20180901101317/http://www.ebay.com/rpp/dvds-movies",
                    txt: "DVDs & movies"
                }, {
                    sp: "m570.l3274",
                    url: "https://web.archive.org/web/20180901101317/http://www.ebay.com/rpp/tickets-experiences",
                ...
                parent: {
                    ...
                    sp: "m570.l3409",
                    url: "https://web.archive.org/web/20180901101317/http://www.ebay.com/rpp/fashion-main",
                    txt: "Fashion"
                },
                children: [{
                    sp: "m570.l3632",
                    url: "https://web.archive.org/web/20180901101317/http://www.ebay.com/rpp/womens-clothing",
                    txt: "Women"
                }, {
                    sp: "m570.l3633",
                    url: "https://web.archive.org/web/20180901101317/http://www.ebay.com/rpp/mens-clothing",
                    txt: "Men"
                }, {
                    sp: "m570.l3634",
                    url: "https://web.archive.org/web/20180901101317/http://www.ebay.com/rpp/watches",
                    txt: "Watches"
                }, {
                    sp: "m570.l3635",
                    url: "https://web.archive.org/web/20180901101317/http://www.ebay.com/rpp/shoes",
                    txt: "Shoes"
                }]
            }, {
                parent: {
                    sp: "m570.l3412",
                    url: "https://web.archive.org/web/20180901101317/http://www.ebay.com/rpp/home-garden",
                    txt: "Home &amp; garden"
                },
                children: [{
                    sp: "m570.l3646",
                    url: "https://web.archive.org/web/20180901101317/http://www.ebay.com/rpp/yard-garden",
                    txt: "Yard, garden &amp; outdoor"
                },
                    {
                        sp: "m570.l3647",
                        url: "https://web.archive.org/web/20180901101317/http://www.ebay.com/rpp/crafts",
                        txt: "Crafts"
                    }, {
                        sp: "m570.l4131",
                        url: "https://web.archive.org/web/20180901101317/http://www.ebay.com/rpp/home-improvement",
                        txt: "Home improvement"
                    }, {
                        sp: "m570.l3773",
                        url: "https://web.archive.org/web/20180901101317/http://www.ebay.com/rpp/pet-supplies",
                        txt: "Pet supplies"
                    }]
            }, {
                parent: {
                    ...
                    sp: "m570.l3411",
                    url: "https://web.archive.org/web/20180901101317/https://www.ebay.com/motors",
                    txt: "Motors"
                },
                children: [{
                    sp: "m570.l3640",
                    url: "https://web.archive.org/web/20180901101317/http://www.ebay.com/rpp/motors-parts-accessories",
                    txt: "Parts & accessories"
                }, {
                    sp: "m570.l3641",
                    url: "https://web.archive.org/web/20180901101317/http://www.ebay.com/sch/Cars-Trucks-/6001/i.html",
                    txt: "Cars & trucks"
                }, {
                    sp: "m570.l3642",
                    url: "https://web.archive.org/web/20180901101317/http://www.ebay.com/rpp/motorcycles",
                    txt: "Motorcycles"
                }, {
                    sp: "m570.l3643",
                    url: "https://web.archive.org/web/20180901101317/http://www.ebay.com/sch/Other-Vehicles-Trailers-/6038/i.html",
                    txt: "Passenger vehicles"
                }]
            }, {
                parent: {
                    sp: "m570.l3414",
                    url: "https://web.archive.org/web/20180901101317/http://www.ebay.com/rpp/sporting-goods",
                    txt: "Sporting goods"
                },
                children: [{
                    sp: "m570.l3648",
                    url: "https://web.archive.org/web/20180901101317/http://www.ebay.com/rpp/outdoor-sports",
                    txt: "Outdoor sports"
                }, {
                    sp: "m570.l4135",
                    url: "https://web.archive.org/web/20180901101317/http://www.ebay.com/rpp/team-sports",
                    txt: "Team sports"
                }, {
                    sp: "m570.l3650",
                    url: "https://web.archive.org/web/20180901101317/http://www.ebay.com/rpp/exercise-fitness",
                    txt: "Exercise & fitness"
                }, {
                    sp: "m570.l3651",
                    url: "https://web.archive.org/web/20180901101317/http://www.ebay.com/rpp/golf",
                    txt: "Golf"
                }]
            }, {
                parent: {
                    sp: "m570.l3645",
                    url: "https://web.archive.org/web/20180901101317/http://www.ebay.com/rpp/toys-and-hobbies",
                    txt: "Toys & hobbies"
                },
                children: [{
                    sp: "m570.l4184",
                    url: "https://web.archive.org/web/20180901101317/https://www.ebay.com/b/Vintage-Antique-Toys/717/bn_1860860",
                    txt: "Vintage & antique toys"
                }, {
                    sp: "m570.l4185",
                    url: "https://web.archive.org/web/20180901101317/http://www.ebay.com/rpp/kids-toys",
                    txt: "Kids toys"
                }, {
                    sp: "m570.l1615",
                    url: "https://web.archive.org/web/20180901101317/http://www.ebay.com/rpp/action-figures",
                    txt: "Action figures"
                }, {
                    sp: "m570.l4186",
                    url: "https://web.archive.org/web/20180901101317/http://www.ebay.com/rpp/dolls-bears",
                    txt: "Dolls & bears"
                }]
            }, {
                parent: {
                    sp: "m570.l3416",
                    url: "https://web.archive.org/web/20180901101317/https://www.ebay.com/v/allcategories",
                    txt: "Other categories"
                },
                children: [{
                    sp: "m570.l3417",
                    url: "https://web.archive.org/web/20180901101317/http://www.ebay.com/rpp/books",
                    txt: "Books"
                }, {
                    sp: "m570.l3420",
                    url: "https://web.archive.org/web/20180901101317/http://www.ebay.com/rpp/health-beauty",
                    txt: "Health & beauty"
                }, {
                    sp: "m570.l3772",
                    url: "https://web.archive.org/web/20180901101317/http://www.ebay.com/rpp/musical-instruments-gear",
                    txt: "Musical instruments & gear"
                }, {
                    sp: "m570.l3768",
                    url: "https://web.archive.org/web/20180901101317/http://www.ebay.com/rpp/business-industrial",
    ...
    ebayContent["GlobalHeaderWeb/GreetingsJavascriptContent"] = {
        greetingDefault: 'Hi! <a href="https://web.archive.org/web/20180901101317/https://signin.ebay.com/ws/eBayISAPI.dll?SignIn&amp;ru=ru" _sp="m570.l1524">Sign in</a>\u00a0<span>or <a href="https://web.archive.org/web/20180901101317/https://reg.ebay.com/reg/PartialReg?ru=ru2" _sp="m570.l2621">register</a></span>',
        greetingRecognized: 'Hi <b>${username}</b> (<a href="https://web.archive.org/web/20180901101317/https://signin.ebay.com/ws/eBayISAPI.dll?SignIn&amp;ru=ru" _sp="m570.l2620">Sign in</a>)',
        greetingAuthenticated: "Hi <b>${username}</b>!",
        greetingOverlaySignout: '<a href="https://web.archive.org/web/20180901101317/https://signin.ebay.com/ws/eBayISAPI.dll?SignIn&amp;lgout=1" _sp="m570.l2622">Sign out</a>',
        profile_mycollections: '<a href="https://web.archive.org/web/20180901101317/http://www.ebay.com/cln/_mycollections">My Collections</a>',
        profile_accountsettings: '<a href="https://web.archive.org/web/20180901101317/https://my.ebay.com/ws/eBayISAPI.dll?MyEbay&amp;CurrentPage=MyeBayMyAccounts">Account settings</a>',
        profile_myworld: '<a href="https://web.archive.org/web/20180901101317/https://www.ebay.com/usr/@@">@#@</a>',
        profile_feedback: '<a title="Feedback score" href="https://web.archive.org/web/20180901101317/https://feedback.ebay.com/ws/eBayISAPI.dll?ViewFeedback2&amp;userid=@@"></a>',
        profile_loginUserL10n: '<a href="https://web.archive.org/web/20180901101317/https://signin.ebay.com/ws/eBayISAPI.dll?SignIn&amp;ru=ru">Sign in</a> to see your user information',
        profile_userAltTxt: "View My World page",
        profile_memberAltTxt: "User ID",
        profile_feedbackscore: '<a href="https://web.archive.org/web/20180901101317/http://my.ebay.com/ws/eBayISAPI.dll?GetGHNotificationsCommand&amp;ghud=1"></a>',
        profile_feedbackscore_new: '<a href="https://web.archive.org/web/20180901101317/http://gha.ebay.com/nproxy/notification/v1/getMinProfile"></a>',
        feedbackTitle: "Feedback Score ${feedback}"
    };
    ebayContent["GlobalHeaderWeb/HiddenFromL10NTeamContent"] = {};
    (function (a) {
        GH.add("Greeting", function () {
            var i = a.extend(GH.Util.getBundle("GreetingsJavascriptContent"), GH.Util.getBundle("HiddenFromL10NTeamContent")),
                l = GH.undefinedStr;
            return {
                init: function () {
                    var f = this, b, e, c = i.greetingDefault, d, g, k, j, h = GH.vCJar,
                    ...
                    e = e.replace(/\+/g,
                        " ");
                    typeof e !== l && 0 <= e.indexOf("?") && (e = null);
                    !(0 === GH.C.sin && GH.C.id) && (typeof b !== l && "" !== b && 0 > b.indexOf("@@__@@__@@")) && (c = i.greetingRecognized, GH.userRecog = !0, GH.userID = b, GH.userFN = e, GH.C.cgi || GH.C["static"] ? (d = h.readCookie("dp1", "pcid")) ? (g = k = decodeURIComponent(h.readCookie("cid")), j = g.indexOf("#"), -1 === j && 8 < g.length || (-1 !== j && (k = g.substring(j + 1, g.length)), k === d && (a(window).on("load.gh", function () {
                        h.writeCookie("cid", g, 365)
                    }), GH.userAuth = !0))) : GH.userAuth = !0 : 1 === GH.C.sin && (GH.userAuth = !0), GH.userAuth &&
                    (c = i.greetingAuthenticated), !GH.userAuth && ("function" === typeof h.getBitFlag && 1 == h.getBitFlag(h.readCookie("dp1", "pbf"), 98)) && (GH.userRecog = !1, c = i.greetingDefault), b = 77 == GH.C.siteId ? b || e : e || b, 13 < b.length && (b = b.substring(0, 12) + "..."), c = GH.Util.mergeContent(c, {username: GH.Util.eZ(b)}));
                    ...
                    GH.userAuth ? (a("#gh-eb-u").html('<button id=gh-ug class="gh-ua gh-control" aria-expanded=false aria-controls=gh-eb-u-o role=button>' +
                        ...
                        var d;
                        d = a("#gh-eb-u").data("mo");
                        var e = a("#gh-eb-u").data("t"), g = (new Date).getTime();
                        a("#gh-eb-u").removeData("mo");
                        if (d || !(e && 400 > g - e)) if (c.preventDefault(), a("#gh-eb-u-o").length) f[a("#gh-eb-u-o").is(":hidden") ? "showUserOverlay" : "hideUserOverlay"](b); else GH.Util.createOverlay("u", 0, b), a("#gh-eb-u-o").data("ghi", 41), GH.Util.openOverlay(a("#gh-ug")), a("#gh-eb-u").addClass("gh-eb-active"), GH.alerts.collectData &&
                        GH.Util.cTImg(GH.ghiIMP + 79), d = GH.Util.getSecURL(GH.Util.getHref(GH.GHSW.newprofile || GH.GHSW.desktop_new_profile_service ? i.profile_feedbackscore_new : i.profile_feedbackscore)), a.ajax(d, {
                            dataType: "jsonp",
                    ...
                    var c = GH.Util.getBundle("GreetingsJavascriptContent"),
                        d, g = a("#gh-eb-u-o"), k = 12, j, h = GH.userID, i = GH.userFN;
                    typeof f === l && GH.userAuth && (f = {});
                    typeof f === l && !b ? (d = "<div class=gh-o-err><span class=gh-o-errb>" + c.profile_loginUserL10n.replace(/&amp;ru=ru/g, "&ru=" + GH.Util.addRU()) + "</span></div>", g.data("ghi", 40), g.html(d)) : (j = f.r || 0, a.each([10, 50, 100, 500, 1E3, 5E3, 1E4, 25E3, 5E4, 1E5, 5E5, 1E6], function (a, b) {
                        if (j < b) return k = a, !1
                    }), d = f.p ? f.p.replace(/http:.*pics\//, GH.pi) : GH.pi + "social/profile_avatar_60x60.png", d = "<ul id=gh-uu role=navigation><li id=gh-up><a _sp=m570.l3331 href='" +
                        GH.Util.getHref(c.profile_myworld).replace("@@", h) + "'><img id=gh-upi src='" + d + "' alt='" + c.profile_userAltTxt + "'></a></li>", d += "<li id=gh-un>" + (f.u || i || "&nbsp;") + "</li><li id=gh-ui>", i = c.profile_myworld.replace('@@"', h + '"_sp=m570.l3332 id="gh-uid"'), i = i.replace("@#@", "<i class=gh-ar-hdn>" + c.profile_memberAltTxt + "</i> " + h), d += i + (!b && GH.userAuth && "undefined" !== typeof f.r ? " (" + c.profile_feedback.replace('@@"', '"_sp=m570.l3333') + ")" : "") + "</li>", d += "<li id=gh-uac>" + c.profile_accountsettings.replace("href=",
                    ...
                    }, 50), d = a("#gh-uu a[_sp='m570.l3333']").html("<span class='gh-ar-hdn'>" + GH.Util.mergeContent(c.feedbackTitle, {feedback: ""}) + "</span>" + j + (0 < k ? "<i id=gh-ur style='background-position:" + -[-3, 16, 35, 54,
                        73, 92, 113, 135, 157, 179, 201, 224][k - 1] + "px " + (7 > k ? "-1px; margin:0 -4px 0 -2px;" : "-2px;") + "' />" : "")).attr("title", GH.Util.mergeContent(c.feedbackTitle, {feedback: j})), d.attr("href", d.attr("href") + h));
    ...
    ebayContent["GlobalHeaderWeb/CouponJavascriptContent"] = {
        ...
        BL10N: '<a href="https://web.archive.org/web/20180901101317/https://my.ebay.com/ws/eBayISAPI.dll?MyEbayBeta&amp;CurrentPage=Rewards&amp;sspagename=ebaybucksheader"></a>',
        BOL10N: '<a href="https://web.archive.org/web/20180901101317/http://my.ebay.com/ws/eBayISAPI.dll?MyEbayBeta&amp;CurrentPage=Rewards&amp;sspagename=ebaybucksheader#b_offer"></a>',
        JL10N: '<a href="https://web.archive.org/web/20180901101317/https://my.ebay.com/ws/eBayISAPI.dll?RewardsIntEnroll&amp;CTASignup=false&amp;ExtLanding=false&amp;ssPageName=ebaybucksheader"></a>',
        CL10N: '<a href="https://web.archive.org/web/20180901101317/https://my.ebay.com/ws/eBayISAPI.dll?MyeBay&amp;CurrentPage=MyeBayIncentives&amp;gbh=1"></a>'
    };
    ebayContent["GlobalHeaderWeb/NotificationsJavascriptContent"] = {
        zeroAlertsL10n: "You're all caught up!",
        loginAlertL10n: 'Please <a href="https://web.archive.org/web/20180901101317/https://signin.ebay.com/ws/eBayISAPI.dll?SignIn&amp;ru=ru" _sp="m570.l2881">sign-in</a> to view notifications.',
        errorAlertL10n: "Notifications are not available at this time",
        alertHeader: "Notifications",
        dataURL: '<a href="https://web.archive.org/web/20180901101317/http://my.ebay.com/ws/eBayISAPI.dll?GetGHNotificationsCommand"></a>',
        clickURL: '<a href="https://web.archive.org/web/20180901101317/http://my.ebay.com/ws/eBayISAPI.dll?SetGHNotificationsReadTSCommand"></a>',
        ...
        proxyURL: '<a href="https://web.archive.org/web/20180901101317/http://gha.ebay.com"></a>',
        latestproxyURL: '<a href="https://web.archive.org/web/20180901101317/http://www.gha.pp.stratus.ebay.com"></a>'
    };
    ebayContent["GlobalHeaderWeb/SYMBAnJavascriptContent"] = {
        ...
        loginAlertL10n: '<a href="https://web.archive.org/web/20180901101317/https://signin.ebay.com/ws/eBayISAPI.dll?SignIn&amp;ru=ru" _sp="m570.l2881">Please <span>sign-in</span> to view notifications.</a>'
    };
    ...
    GH.GHN_SURVEY_HTML = "";
    GH.GH_NOTIF_TMPL_LINK = "https://web.archive.org/web/20180901101317/https://ir.ebaystatic.com/rs/v/3t4uoe3epa3mnh3ayt1j1pos2y1.js";
    ...
    function GHalertServiceConf() {
        ...
        "qa" === GH.GHSW.pool || "dev" === GH.GHSW.pool ? a = c.getSecURL(c.getHref(a.proxyURL)) : "latest" === GH.GHSW.pool ?
            (a = c.getSecURL(c.getHref(a.latestproxyURL)), a = a.replace("latest.", "")) : a = c.getSecURL(c.getHref(a.proxyURL));
        b = {
        ...
        return {
            ...
            ajaxProperties: {
                dataType: "jsonp",
                jsonp: !1, jsonpCallback: "GH_alertData", cache: !1, timeout: 2500
            },
            ...
            trackingUserType: {
                CNTROFFR: {B: 101, S: 102},
                COACCPTED: {B: 103, S: 104}, CODECLND: {B: 105, S: 106}
            },
    ...
    function GHalertObjData(d, H) {
        var e = H.Conf, C = function (a) {
                return (void 0 !== a || void 0 !== a.errorMessage) && void 0 !== a.errorMessage && void 0 !== a.errorMessage.error ? a.errorMessage.error : !1
            }, Q = e.ajaxUpdateProperties, n = {}, v = GH.alertsGroup, k = e.alertURL, A = void 0, l = e.undefinedStr,
            x = e.STATUS, R = e.NOTIFTYPE, y = H.Util, D = 0, S = e.tracking, g = {}, T = e.countdownType, E = -1,
            s = "", h = void 0, o = !1, I = !1, J = -1, F = function (a) {
                ...
                var b = 0, c = function (a) {
                    ...
                    b++;
                    f()
                }, u = d.extend(Q, {success: c, error: j}), f = function () {
                    b < e.retryAjaxUpdate && d.ajax(a, u)
                };
                return {put: f, successCB: c, errorCB: j}
            }, r, z = !1, L = function (a, b) {
                z = !1;
                h = void 0;
                o = !1;
        ...
        v.init(e);
        return {
            PUTWrapper: t, getBucket: function () {
                return g
                ...
                return b
            }, getItemKey: p, getItemKeyName: function (a) {
                return "" + a.name
            }, getItemId: B, getItemCreatedTime: function (a) {
                ...
                return a.ct
            }, getItemEndTime: O, getItemGroup: function (a) {
            ...
            isGroup: function (a) {
                ...
                return a
            }, isNewOrPopUp: K, isZeroData: function (a) {
                return 0 === (void 0 === a.notifications ? a.d.length : a.notifications.length) ? !0 : !1
            ...
            isDuplicate: function (a, b, c) {
                ...
                var j, d = a.length, f, e = y.getCurrentTime(), i = "";
                ...
                n = a
                                      ...
                                      b, c) {
                var j = !1, d = GH.Util.isTouchDevice(), f = "", h = "&transactionId", c = p(a), i = c + "l",
                    g = c + "lp", w = "", s = "ghn-cd", k = "MSGM2MMSGHDR" === p(a) ? !0 : !1, o, m;
                m = "";
                ...
                typeof T[p(a)] !== l && !c && (m = O(a), void 0 !== m && (w = y.getTimeDiff(m, b), w === y.tlf.e ? (m = y.tlf.e, w = "<div class='ghn-cd-div'><span  class='" + (s + " ghn-cd-end") + "'>" + m + "</span></div>") : (b = "<span class='ghn-acc-txt'>" + e.messageAlertL10N.timer + "</span>", m = "<span class='ghn-cd-sub0' aria-hidden='true'>" + w.t0 + "</span><span class='ghn-acc-txt ghn-cd-sub1'>" + w.t1 + "</span>", w = "<div class='ghn-cd-div'>" +
                    GH.Util.mergeContent(b, {timeleft: "<span  class='" + s + "'>" + m + "</span>"}) + "</div>")));
            ...
            }, isSYMBAnError: C, getTotalNumNotifs: function () {
                return A
            },
            getServiceName: function () {
                ...
                return b
            }, conf: e, getLastUpdateTimeStamp: function () {
                return E
                ...
                e.enablePagination && void 0 !== h && (o = !0, d(a).on("scroll.ghn-pagination", function () {
                    var c =
                            d(a), j = c[0].scrollHeight - c.scrollTop() - c.height(),
                ...
                return o
            }, getNexParamsFromURL: M, loadMoreNotifs: function (a, b, c, d, e) {
    ...
    function GHalertObj(f, Ua, Va) {
        var c = f.jQ, O = Va(Ua, c), g = GHalertObjData(c, O), qa = g.isNewDataValid, Fa = g.setNextURL,
            ...
            Q, B, t, Ia, j = null, ca = "", da = "", C = null, R = null, Ja = null, H = 0, Za = O.Const, l = g.conf,
            $a = l.GHlocalStorage, m = l.undefinedStr, n = O.Util, p = O.Tracking(l, g), ab = O.Storage, bb = Za.TITLE,
            ta = l.newalertsasync, ea = l.design, u = {
                size: 115, startPosition: c("#gh").outerHeight(),
                position: c("#gh").outerHeight(), count: 0
            }, S = l.lastMinuteNotif, cb = l.countdownType, Ka = l.secCountDown, T = l.STATUS, z = l.messageAlertL10N,
            db = void 0 !== l.tlf.e ? l.tlf : void 0,
            fa = {2: f.Util.addSignin(z.loginAlertL10n), 4: z.zeroAlertsL10n, 6: z.errorAlertL10n, 3: z.errorAlertL10n},
            I = l.alertURL, ua = "0", ga = l.refreshAllDataFlag, d = l.polling, va = d.secWaitActivity, ha = {},
            e = null, U = [], k = null, wa = null, V = 0, r = {}, ia = {}, w = !1, xa = !1, W = !1, ja = null, s = null,
            D = {}, J = {}, La, q = 0, X = -1, K = -1, ya = !1, Y = !1, ka = !1,
            eb = void 0 !== z.survey ? z.survey : "", Ma = f.GHN_SURVEY_HTML ?
                f.Util.addPrefixPoolURL(f.GHN_SURVEY_HTML.replace("#DESIGN#", "2" === ea ? "Priority" : "Recency").replace("#SVTXT#", eb)) : "",
            E = !~~(100 * Math.random()), Na = typeof JSON === m ? 0 : l.enableLocalStorage,
            i = $a && n.isLocalStorageSupported && Na ? ab : null, Z = !1, A = function (a) {
                ...
                var a = 30, b = typeof d !== m ? d.pollingFrequency : 0;
            ...
            Ra = function (a) {
                ...
                "true" !== f.GHSW.NEWALERT_POPUPOFF && g.isPopUp(a) && (c(ca + da).length ? setTimeout(function () {
                    ...
                    var b = a, o = aa(b, 2), o = c("<div class='ghn-pop-wrap'>" +
                        o + "</div>"), h = "#ghn-pop-" + x(b), e = !1, d = !1;
                    f.Util.cTImg(f.ghiIMP + 54 + "&_trkparms=" + p.rowTrack("gh1g", b));
                    0 < c(h).length && c(h).parent().hide("slow").remove();
                    c(ca + da).length ? N() : (c(o).appendTo("body"), c.fn.ghellipsis && c(h + " .ghn-desc-o").ghellipsis({row: 2}), c(o).css({top: u.position + "px"}).animate({right: "0px"}, function () {
                        c(ca + da).length && N()
            ...
            N = function (a) {
                ...
                var b = z.many, o = ("" + a).length;
                c(Q + " i.ghn-num").remove();
                a ? (c(Q + " " + j.ebAClass).append("<i aria-hidden='true' " + (newNotifFlag ? "class='ghn-new ghn-num'" : "class=' ghn-num'") + " id=gh-eb-Alerts-n" + o + ">" + (99 < a ? "99+" : a) + "</i>"), 1 == a && (b = z.one), b = f.Util.mergeContent(b, {itemcount: a})) :
                    (o = 0, b = z.zero);
                ...
                var o, h, d, i = "", l = c.isArray(a) ? !1 : !0, m = "%26", j = !1, k = c(t + " li").length;
                s = a;
                if (l) {
                    if (!qa(a)) return;
                ...
                v(!0, !0);
                !1 !== b && (0 < i.length && (c(t).append(i), c.fn.ghellipsis && c(B).is(":visible") && c(".ghn-desc-o").ghellipsis({row: 2}), j && (f.Util.cTImg(f.ghiIMP + 5 + m), p.overlayLastIdxSojDropped = k)), c(".ghn-i").each(function (a, b) {
                    n.createImage(b)
                }))
            }, y = function (a) {
                var b = "", o = "%26",
                    h = 0, d = B, b = 0, i = j.overlayTemplate;
                ...
                }), a && e.length < H && (b += "<li class='ghn-o-l'><div class='gh-o-l'></div></li>"), 0 >= b.length ? ba(d, 4) : (b = i.replace("#TEXT#", b).replace("#SURVEY#", Ma), c(d).html(b), U.length && Ba(U), c.fn.ghellipsis && c(d).is(":visible") && c(".ghn-desc-o").ghellipsis({row: 2}), b = c(t + " li").length, a = b >= H ? j.overlayHeight : b * j.itemHeight, c.fn.scrollLock &&
                ...
                Y = !1;
                s = a;
                if (b || g.isHandleNotifNeedUpdated(a)) if (Pa(), qa(a)) if (g.isZeroData(a) ? (h = !0, b ? v(!1) : v(!0, !1), d.zeroFlag = !0) : d.zeroFlag = !1, a = g.convertItemType(a), b || (Fa(a.next), U = [], void 0 !== G() && (g.getIsScrollEventAdded() || g.addScrollEvent())), void 0 !== g.handleNewNotif && (a = g.handleNewNotif(a, e)), h) C() && !R() && y(); else {
                    e = a;
            ...
            init: function () {
                ...
                if (f.userRecog) {
                    ...
                    if (null === i) if (ta) a(!0); else c(window).on("load.gh", function () {
                        ...
                        if (0 >= b) if (ta) a(!0); else c(window).on("load.gh", function () {
                            a(!1)
                        }); else {
        ...
        var r = null, n = null, w = GH.Util.getBundle("NotificationsJavascriptContent"), t = GHalertObj,
            q = function (l, h) {
                if (null === r) {
                    ...
                    p = {
                        tlf: null, getTimeDiff: function (a, c) {
                            var b, i = p.tlf, j = {}, m = "", f = "", e = "", f = "", d, g = o.messageAlertL10N;
                            ...
                            j.t1 = f;
                            return j
                        }, sizeCheck: u, sort: function (a, c, b, i) {
                            a = 0 === b ? a - c : c - a;
                            return 0 !== a ? a : i()
                    ...
                    r = {
                        Const: {TITLE: w.alertHeader}, Conf: o, Util: p, Tracking: function (a,
                                                                                             c) {
                            var b = {}, i = a.tracking, j = a.trackingUserType;
                            ...
                            return {
                                ...
                                addTotalByTrackId: function (a, f) {
                                    var e;
                                    e = c.getItemKey(a);
                                    var d = i[e], g = a.buyerNotification;
                                ...
                                rowTrack: function (a, b, e) {
                                    var d = c.getItemKey(b), g = c.getItemGroup(b), h;
                            ...
                            timestamp: -1, updatedTimestamp: -1, data: null, key: "ghn_data", lData: {},
                            lKey: "ghn_ldata", userID: l, refreshLocalStorage: 30, removeLocalStorage: function () {
                                ...
                                h.isEmptyObject(this.lData) ? k.removeItem(this.lKey) : k.setItem(this.lKey,
                                    JSON.stringify({userID: l, d: this.lData}))
    ...
    function GHalertDesktop(k, g, h, b) {
        var c = k(b).require("AlertObj", [g, h]), j = g.ghEBActive_id, k = "." + j, i = b("#gh-eb-Alerts"), l = !1,
            m = 0;
        onRemoveNotiifcation = function (a, e) {
            ...
            if ("none" === b(d).find("i").css("display")) return a.stopPropagation(), a.preventDefault(), f.find("a.ghn-a-itm").trigger(a.type),
                !1;
            if (f.find(".ghn-confirm").length) b(d).closest("li").find(".ghn-a-itm").addClass("disable").end().find(".ghn-desc").hide().end().find(".ghn-confirm").show(); else {
                var e = f.attr("data-uid") || li.attr("data-id"), h = f.attr("data-groupid");
                a.preventDefault();
        ...
        addEventOnOverlay = function () {
            ...
            i.delegate("#gh-eb-Alerts-o a.ghn-a-itm", "click touchend", function (a) {
                var e = b(this).parent(), d = e.attr("data-uid"), f = e.attr("data-id");
                void 0 === d && (d = f);
                a.preventDefault();
        ...
        var h = {addEvent: addEvent}, o = function (a, c) {
            25 < c ? b("#gh-eb-Alerts .gh-control").focus() : setTimeout(function () {
                var d = b("#gh-eb-Alerts-o a:first"), f = b("#ghn-err");
        ...
        return b.extend(c, {
            ...
            openOverlay: function (a, e, d) {
                ...
                b.fn.ghellipsis && b(e).is(":visible") && b(".ghn-desc-o").ghellipsis({row: 2});
                a.addClass(j)
            },
    ...
    (function (d) {
        GH.add("Cart", function () {
            var c = GH.vCJar, a = GH.C.ct, e = d("#gh-cart a"), f = GH.Util.getBundle("Cart");
            return {
                init: function () {
                    var b = this;
                    ...
                    if (e.length) {
                        ...
                        a && (a = GH.Util.mergeContent(a, {itemcount: b}), e.attr({title: a, alt: a}));
    ...
    ebayContent["GlobalHeaderWeb/AutocompleteJavascriptContent"] = {
        ...
        acCatalog: '<a href="https://web.archive.org/web/20180901101317/http://www.ebay.com/ctg/?_pid=#P#&amp;_trksid="></a>',
            ...
            return {
                acDisabledClass: "gh-acHidden", init: function (g) {
                    ...
                    !g && e && 1 == e.getBitFlag(e.readCookie("dp1", "pbf"), 29) ? (a(GH.ghAC_id).after("<a id=ghAC-show class='gh-spr icas' title='" + h.acShowSuggestions + "' href='#'></a>"), a(GH.componentID).addClass(d.acDisabledClass), a(GH.ghAC_id).attr({
                        ...
                        GH.sec && (b = b.replace(/^http:\/\/ir./, "https://web.archive.org/web/20180901101317/https://secureir."));
                        a.ajax(b, {
    ...
    ebayContent["GlobalHeaderWeb/PersonalizationJavascriptContent"] = {bullseye_url: '<a href="https://web.archive.org/web/20180901101317/http://gha.ebay.com/nproxy/notification/v1/bullseye"></a>'};
    (function (b) {
            ...
            return {
                execute_immediately: function () {
                    ...
                    if (b && b.ajax) b(window).on("load.gh", function () {
                        window.setTimeout(function () {
                            b.ajax(c, {dataType: "jsonp", jsonpCallback: "GH_personalizedData"})
                        }, 1)
    ...
    ebayContent["GlobalHeaderWeb/InflowJSContent"] = {url: '<a href="https://web.archive.org/web/20180901101317/http://ocsrest.ebay.com/ocsrsapp/o2/inflow/inflowcomponent?callback=Inflow.cb"></a>'};
    (function () {
        GH.add("Inflow", function () {
            return {
                init: function () {
                    ...
                    for (var a = 1; a < arguments.length; a++) for (var b in arguments[a]) arguments[a].hasOwnProperty(b) && (arguments[0][b] =
                        arguments[a][b]);
                    return arguments[0]
                }, loadScript: function (a) {
            ...
            return {
                init: function () {
                    if (typeof GH.C.lng === GH.undefinedStr && (typeof GH.C.geoLang === GH.undefinedStr || "[]" == GH.C.geoLang)) {
                        var d = GH.C.qapool ? "https://web.archive.org/web/20180901101317/https://api4.qa.ebay.com/mobile" : "https://web.archive.org/web/20180901101317/https://mobipushpkg.ebay.com/mobile",
                            e = GH.C.qapool ? "https://web.archive.org/web/20180901101317/https://api4.qa.ebay.com/mobile/v1/devices/token/sync/web.com.ebay.site" : "https://web.archive.org/web/20180901101317/https://mobipushpkg.ebay.com/mobile/v1/devices/token/sync/web.com.ebay.site",
    ...
    ebayContent["GlobalHeaderWeb/BackToTopJavascriptContent"] = {arrowImage: '<img title="Scroll to top" src="https://web.archive.org/web/20180901101317/http://ir.ebaystatic.com/pictures/aw/pics/globalheader/btt.png" alt="Scroll to top" border="0" height="76" width="33" _id="gh-bti"/>'};
    (function (c) {
...
/*
     FILE ARCHIVED ON 10:13:17 Sep 01, 2018 AND RETRIEVED FROM THE
...
/*
playback timings (ms):
  captures_list: 263.864
  exclusion.robots: 0.082
  exclusion.robots.policy: 0.071
  cdx.remote: 0.057
  esindex: 0.009
  LoadShardBlock: 227.461 (3)
  PetaboxLoader3.datanode: 273.166 (5)
  load_resource: 228.374 (2)
  PetaboxLoader3.resolve: 144.341 (2)
*/
