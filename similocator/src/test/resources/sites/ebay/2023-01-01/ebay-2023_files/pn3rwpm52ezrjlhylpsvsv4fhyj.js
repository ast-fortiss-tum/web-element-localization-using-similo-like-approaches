...
}
{
    ...
    ebayContent["GlobalHeaderWeb/GHJavascriptContent"] = {
        ...
        signinURL: '<a href="https://web.archive.org/web/20230901121114/https://signin.ebay.com/ws/eBayISAPI.dll?SignIn"></a>',
        errL10n: "Sorry, this feature is currently not supported on this page",
        roverurl: '<a href="https://web.archive.org/web/20230901121114/http://rover.ebay.com"></a>',
        ...
        GH.add("Util", function () {
            ...
            return {
                ...
                getBundle: function (a) {
                    ...
                    var b = l.getTarget(a), d = document.querySelector("#gh-ul-nav");
                    c("#" + b).show();
                    ...
                    a.each(function () {
                        var a = c(this);
                        a[0].hasAttribute("aria-expanded") && a.attr("aria-expanded", "false");
                        a = l.getTarget(a);
                ...
                toggleOverlay: function (a) {
                    ...
                    GH.Util.hideOverlays();
                    c(d).append("<div id=gh-eb-" + a + "-o class='gh-eb-o'" + (b ? " aria-busy=true aria-live=polite" : "") + " style='" + (180 < e ? "min-width:" + e + "px" : "") + "' aria-hidden=false><div class=gh-o-l>" +
                        q.msg_loading + "</div></div>")
                    ...
                    d && (c = "");
                    d = RegExp(c + "http:");
                    GH.sec && (a = a.replace(d, "https:"), b && (b = RegExp(c + "https://web.archive.org/web/20230901121114/https://ir."), c = RegExp(c + "https://web.archive.org/web/20230901121114/https://pics."), a = a.replace(b, "https://web.archive.org/web/20230901121114/https://secureir."), a = a.replace(c, "https://web.archive.org/web/20230901121114/https://securepics.")));
                    return a
                    ...
                    var b = GH.GHSW.pool ? GH.GHSW.pool : null, d = c.isArray(a), e = "string" === typeof a,
                        ...
                        h = GH.siteSpecific.maprules["function" == typeof h.indexOf && -1 >= h.indexOf(parseInt(GH.C.siteId)) &&
                        b && "qa" == b ? "paradise" : b];
                    ...
                    c.getScript(GH.Util.getRoverUrl() + "/roverclk/0/0/9?trknvp=sid%3Dp" +
                        n + "." + c(a.target).attr("_exsp"), function () {
                        document.location = b
                    });
                    a.preventDefault();
                    ...
                    var b = {}, d = function () {
                        ...
                        for (var b = 0; b < a.length; b++) if (a[b] + "Hidden" in
                            document) return a[b] + "Hidden";
                        return null
                    }, e = function () {
                        var a;
                        a = (a = d()) ? document[a] : !1;
                    ...
                    a.vCJar = {
                        readCookie: function (a, m) {
                            ...
                            var b =
                                this.readCookieObj("ebay", "cv").value, c;
                            if (!(a in h)) return null;
                            if (!b) return "";
                            if (0 === b) return "00";
                            if (b && "0" != b) {
                                if (-1 != b.indexOf(".")) for (var d = b.split("."), b = 0; b < d.length; b++) c = parseInt(d[b], 16).toString(2) + c; else c = parseInt(b, 16).toString(2);
                    ...
                    if (GH.oldDT && !r("noStandardCSS")) {
                        ...
                        a = (l.sec ? "https://web.archive.org/web/20230901121114/https://secureinclude" : "https://web.archive.org/web/20230901121114/http://include") + ".ebaystatic.com/css/v/us/legacy/" + a + ".css";
                        c.getCSS(a)
                    }
    ...
    ebayContent["GlobalHeaderWeb/FooterJavascriptContent"] = {
        mftrLinkURL: '<a href="https://web.archive.org/web/20230901121114/http://www.m.ebay.com"></a>',
        mftrLinkURLUnified: '<a href="https://web.archive.org/web/20230901121114/http://www.ebay.com"></a>'
    };
    (function (a) {
            ...
            return {
                init: function () {
                    ...
                    !e.hideMobile && (GH.userAgent.match(/android.*mobile|bntv|blackberry|bb10|webos|iemobile|silk|cloud9|iphone/i) &&
                        !GH.userAgent.match(/kindle|Nexus 7|NOOK|BNTV/i)) && a.cachedScript(GH.Util.getSecURL("https://web.archive.org/web/20230901121114/https://ir.ebaystatic.com/cr/v/c01/mFtrLnk-min-v1.js", !0));
                ...
                showFlagsOverlay: function (c) {
                    var b = a("#gf-f"), d = a("#gf-f a"), e = "click" == c.type;
    ...
    GH.getShopByCatData = function () {
        return {
            data: [{
                parent: {
                    sp: "m570.l3410",
                    url: "https://web.archive.org/web/20230901121114/https://www.ebay.com/b/Auto-Parts-and-Vehicles/6000/bn_1865334",
                    txt: "Motors"
                },
                children: [{
                    sp: "m570.l3638",
                    url: "https://web.archive.org/web/20230901121114/https://www.ebay.com/b/Auto-Parts-Accessories/6028/bn_569479",
                    txt: "Parts & accessories"
                }, {
                    sp: "m570.l3637",
                    url: "https://web.archive.org/web/20230901121114/https://www.ebay.com/b/Cars-Trucks/6001/bn_1865117",
                    txt: "Cars & trucks"
                }, {
                    sp: "m570.l3636",
                    url: "https://web.archive.org/web/20230901121114/https://www.ebay.com/b/Motorcycles/6024/bn_1865434",
                    txt: "Motorcycles"
                }, {
                    sp: "m570.l3639",
                    url: "https://web.archive.org/web/20230901121114/https://www.ebay.com/b/Other-Vehicles-Trailers/6038/bn_1865426",
                    txt: "Other vehicles"
                }]
            }, {
                parent: {
                    ...
                    sp: "m570.l3409",
                    url: "https://web.archive.org/web/20230901121114/https://www.ebay.com/b/Clothing-Shoes-Accessories/11450/bn_1852545",
                    txt: "Clothing & Accessories"
                },
                children: [{
                    sp: "m570.l3632",
                    url: "https://web.archive.org/web/20230901121114/https://www.ebay.com/b/Women/260010/bn_7116391826",
                    txt: "Women"
                }, {
                    sp: "m570.l3633",
                    url: "https://web.archive.org/web/20230901121114/https://www.ebay.com/b/Men/260012/bn_7116419459",
                    txt: "Men"
                }, {
                    sp: "m570.l3634",
                    url: "https://web.archive.org/web/20230901121114/https://www.ebay.com/b/Designer-Handbags/bn_7117629183",
                    txt: "Handbags"
                }, {
                    sp: "m570.l3635",
                    url: "https://web.archive.org/web/20230901121114/https://www.ebay.com/b/Collectible-Sneakers/bn_7000259435",
                    txt: "Collectible Sneakers"
                }]
            }, {
                parent: {
                    sp: "m570.l3414",
                    url: "https://web.archive.org/web/20230901121114/https://www.ebay.com/b/Sporting-Goods/888/bn_1865031",
                    txt: "Sporting goods"
                },
                children: [{
                    sp: "m570.l3648",
                    url: "https://web.archive.org/web/20230901121114/https://www.ebay.com/b/Hunting-Equipment/7301/bn_1865054",
                    txt: "Hunting Equipment"
                }, {
                    sp: "m570.l4135",
                    url: "https://web.archive.org/web/20230901121114/https://www.ebay.com/b/Golf-Equipment/1513/bn_1849088",
                    txt: "Golf Equipment"
                }, {
                    sp: "m570.l3648",
                    url: "https://web.archive.org/web/20230901121114/https://www.ebay.com/b/Outdoor-Sports/159043/bn_1855398",
                    txt: "Outdoor sports"
                },
                    {
                        sp: "m570.l3651",
                        url: "https://web.archive.org/web/20230901121114/https://www.ebay.com/b/Cycling-Equipment/7294/bn_1848937",
                ...
                parent: {
                    ...
                    sp: "m570.l3413",
                    url: "https://web.archive.org/web/20230901121114/https://www.ebay.com/b/Electronics/bn_7000259124",
                    txt: "Electronics"
                },
                children: [{
                    sp: "m570.l3653",
                    url: "https://web.archive.org/web/20230901121114/https://www.ebay.com/b/Computers-Tablets-Network-Hardware/58058/bn_1865247",
                    txt: "Computers, Tablets & Network Hardware"
                }, {
                    sp: "m570.l3652",
                    url: "https://web.archive.org/web/20230901121114/https://www.ebay.com/b/Cell-Phones-Smart-Watches-Accessories/15032/bn_1865441",
                    txt: "Cell Phones, Smart Watches & Accessories"
                }, {
                    sp: "m570.l3655",
                    url: "https://web.archive.org/web/20230901121114/https://www.ebay.com/b/Gaming/1249/bn_1850232",
                    txt: "Video Games & Consoles"
                }, {
                    sp: "m570.l3654",
                    url: "https://web.archive.org/web/20230901121114/https://www.ebay.com/b/Cameras-Photo/625/bn_1865546",
                    txt: "Cameras & Photo"
                }]
            }, {
                parent: {
                    sp: "m570.l3649",
                    url: "https://web.archive.org/web/20230901121114/https://www.ebay.com/b/Business-Industrial/12576/bn_1853744",
                    txt: "Business & Industrial"
                },
                children: [{
                    sp: "m570.l3275",
                    url: "https://web.archive.org/web/20230901121114/https://www.ebay.com/b/Modular-Prefabricated-Buildings/55805/bn_2310190",
                    txt: "Modular & Pre-Fabricated Buildings"
                },
                    {
                        sp: "m570.l3771",
                        url: "https://web.archive.org/web/20230901121114/https://www.ebay.com/b/Test-Measurement-Inspection-Equipment/181939/bn_16566063",
                        txt: "Test, Measurement & Inspection Equipment"
                    }, {
                        sp: "m570.l4133",
                        url: "https://web.archive.org/web/20230901121114/https://www.ebay.com/b/Heavy-Equipment-Parts-Attachments/257887/bn_114721174",
                        txt: "Heavy Equipment, Parts & Attachments"
                    }, {
                        sp: "m570.l3274",
                        url: "https://web.archive.org/web/20230901121114/https://www.ebay.com/b/Restaurant-Food-Service/11874/bn_1865467",
                ...
                parent: {
                    title: "Your new destination for Clothing, Shoes &amp; Accessories on eBay",
                    sp: "m570.l3409",
                    url: "https://web.archive.org/web/20230901121114/https://www.ebay.com/b/Jewelry-Watches/281/bn_1865273",
                    txt: "Jewelry & Watches"
                },
                children: [{
                    sp: "m570.l3632",
                    url: "https://web.archive.org/web/20230901121114/https://www.ebay.com/b/Luxury-Watches/31387/bn_36841947",
                    txt: "Luxury Watches"
                }, {
                    sp: "m570.l3633",
                    url: "https://web.archive.org/web/20230901121114/https://www.ebay.com/b/Wristwatches/31387/bn_2408451",
                    txt: "Wristwatches"
                }, {
                    sp: "m570.l3634",
                    url: "https://web.archive.org/web/20230901121114/https://www.ebay.com/b/Fashion-Jewelry/10968/bn_2408529",
                    txt: "Fashion Jewelry"
                }, {
                    sp: "m570.l3635",
                    url: "https://web.archive.org/web/20230901121114/https://www.ebay.com/b/Fine-Jewelry/4196/bn_2408477",
                    txt: "Fine Jewelry"
                }]
            },
                {
                    parent: {
                        sp: "m570.l3412",
                        url: "https://web.archive.org/web/20230901121114/https://www.ebay.com/b/Collectibles-Art/bn_7000259855",
                        txt: "Collectibles &amp; Art"
                    },
                    children: [{
                        sp: "m570.l3646",
                        url: "https://web.archive.org/web/20230901121114/https://www.ebay.com/b/Trading-Cards/bn_7116496578",
                        txt: "Trading Cards"
                    }, {
                        sp: "m570.l3647",
                        url: "https://web.archive.org/web/20230901121114/https://www.ebay.com/b/Collectibles/1/bn_1858810",
                        txt: "Collectibles"
                    }, {
                        sp: "m570.l4131",
                        url: "https://web.archive.org/web/20230901121114/https://www.ebay.com/b/Coins-Paper-Money/11116/bn_1857806",
                        txt: "Coins & Paper Money"
                    }, {
                        sp: "m570.l3773",
                        url: "https://web.archive.org/web/20230901121114/https://www.ebay.com/b/Sports-Memorabilia-Fan-Shop-Sports-Cards/64482/bn_1857919",
                        txt: "Sports Memorabilia"
                    }]
                }, {
                    parent: {
                        sp: "m570.l3412",
                        url: "https://web.archive.org/web/20230901121114/https://www.ebay.com/b/Home-Garden/11700/bn_1853126",
                        txt: "Home &amp; garden"
                    },
                    children: [{
                        sp: "m570.l3646",
                        url: "https://web.archive.org/web/20230901121114/https://www.ebay.com/b/Yard-Garden-Outdoor-Living-Items/159912/bn_1853607",
                        txt: "Yard, Garden & Outdoor Living Items"
                    }, {
                        sp: "m570.l3647",
                        url: "https://web.archive.org/web/20230901121114/https://www.ebay.com/b/Tools-Workshop-Equipment/631/bn_1851815",
                        txt: "Tools & Workshop Equipment"
                    }, {
                        sp: "m570.l4131",
                        url: "https://web.archive.org/web/20230901121114/https://www.ebay.com/b/Home-Improvement/159907/bn_1851980",
                        txt: "Home Improvement"
                    },
                        {
                            sp: "m570.l3773",
                            url: "https://web.archive.org/web/20230901121114/https://www.ebay.com/b/Kitchen-Dining-Bar-Supplies/20625/bn_1865564",
                            txt: "Kitchen, Dining & Bar Supplies"
                        }]
                }, {
                    parent: {
                        sp: "m570.l3416",
                        url: "https://web.archive.org/web/20230901121114/https://www.ebay.com/n/all-categories",
                        txt: "Other categories"
                    },
                    children: [{
                        sp: "m570.l3417",
                        url: "https://web.archive.org/web/20230901121114/https://www.ebay.com/b/Books-Movies-Music/bn_7000259849",
                        txt: "Books, Movies & Music"
                    }, {
                        sp: "m570.l3420",
                        url: "https://web.archive.org/web/20230901121114/https://www.ebay.com/b/Toys-Hobbies/220/bn_1865497",
                        txt: "Toys & Hobbies"
                    }, {
                        sp: "m570.l3772",
                        url: "https://web.archive.org/web/20230901121114/https://www.ebay.com/b/Health-Beauty/26395/bn_1865479",
                        txt: "Health & Beauty"
                    }, {
                        sp: "m570.l3768",
                        url: "https://web.archive.org/web/20230901121114/https://www.ebay.com/b/Baby-Essentials/2984/bn_1854104",
                        txt: "Baby Essentials"
                    }]
                }, {
                    parent: {
                        id: "gh-shop-by-brand",
                        sp: "m570.l45017",
                        url: "https://web.archive.org/web/20230901121114/https://www.ebay.com/n/all-brands",
                        txt: "All Brands"
                    }, children: []
                }, {
                    parent: {
                    ...
                    parent: {
                        id: "gh-shop-by-sale",
                        sp: "m570.l3601",
                        url: "https://web.archive.org/web/20230901121114/https://www.ebay.com/b/Sales-Events/bn_7115049177",
            ...
            return {
                controlID: "#gh-cat", init: function () {
                    ...
                    if (typeof GH.getCategories == GH.functionStr) {
                        ...
                        f = c.length;
                        if (4340 ==
                            GH.C.pageId || 2047675 == GH.C.pageId || 2332490 == GH.C.pageId) h = 0;
    ...
    ebayContent["GlobalHeaderWeb/GreetingsJavascriptContent"] = {
        greetingDefault: 'Hi! <a href="https://web.archive.org/web/20230901121114/https://signin.ebay.com/ws/eBayISAPI.dll?SignIn&amp;ru=ru" _sp="m570.l1524">Sign in</a>\u00a0<span>or <a href="https://web.archive.org/web/20230901121114/https://signup.ebay.com/pa/crte?ru=ru2" _sp="m570.l2621">register</a></span>',
        greetingRecognized: 'Hi <b>${username}</b> (<a href="https://web.archive.org/web/20230901121114/https://signin.ebay.com/ws/eBayISAPI.dll?SignIn&amp;ru=ru" _sp="m570.l2620">Sign in</a>)',
        greetingAuthenticated: "Hi <b>${username}</b>!",
        greetingOverlaySignout: '<a href="https://web.archive.org/web/20230901121114/https://signin.ebay.com/ws/eBayISAPI.dll?SignIn&amp;lgout=1" _sp="m570.l2622">Sign out</a>',
        profile_mycollections: '<a href="https://web.archive.org/web/20230901121114/http://www.ebay.com/cln/_mycollections">My Collections</a>',
        profile_accountsettings: '<a href="https://web.archive.org/web/20230901121114/https://accountsettings.ebay.com/uas">Account settings</a>',
        profile_myworld: '<a href="https://web.archive.org/web/20230901121114/https://www.ebay.com/usr/@@">@#@</a>',
        profile_feedback: '<a title="Feedback score" href="https://web.archive.org/web/20230901121114/https://www.ebay.com/fdbk/feedback_profile/@@"></a>',
        profile_loginUserL10n: '<a href="https://web.archive.org/web/20230901121114/https://signin.ebay.com/ws/eBayISAPI.dll?SignIn&amp;ru=ru">Sign in</a> to see your user information',
        ...
        profile_feedbackscore: '<a href="https://web.archive.org/web/20230901121114/http://my.ebay.com/ws/eBayISAPI.dll?GetGHNotificationsCommand&amp;ghud=1"></a>',
        profile_feedbackscore_new: '<a href="https://web.archive.org/web/20230901121114/http://gha.ebay.com/nproxy/notification/v1/getMinProfile"></a>',
    ...
    (function (b) {
        GH.add("Greeting", function () {
            ...
            return {
                init: function () {
                    var e = this, a, c, d = m.greetingDefault, f, g, i, j, h = GH.vCJar,
                    ...
                    var p = GH.C.sin,
                        o = "undefined" !== typeof window.supressUserGreeting && window.supressUserGreeting;
                    !(0 === GH.C.sin && GH.C.id) && (typeof a !== n && "" !== a && 0 > a.indexOf("@@__@@__@@")) && (d = m.greetingRecognized, GH.userRecog = !0, GH.userID = a, GH.userFN = c, GH.C.cgi || GH.C["static"] ? (f = h.readCookie("dp1", "pcid")) ? (g = i = decodeURIComponent(h.readCookie("cid")), j = g.indexOf("#"), -1 === j && 8 < g.length || (-1 !== j && (i = g.substring(j + 1, g.length)), i === f && (b(window).on("load.gh",
                        function () {
                            h.writeCookie("cid", g, 365)
                        }), GH.userAuth = !0))) : GH.userAuth = !0 : 1 === GH.C.sin && (GH.userAuth = !0), GH.userAuth && (d = m.greetingAuthenticated), !GH.userAuth && ("function" === typeof h.getBitFlag && 1 == h.getBitFlag(h.readCookie("dp1", "pbf"), 98)) && (GH.userRecog = !1, d = m.greetingDefault), a = 77 == GH.C.siteId ? a || c : c || a, 13 < a.length && (a = a.substring(0, 12) + "..."), d = !o || o && 1 === p ? GH.Util.mergeContent(d, {username: GH.Util.eZ(a)}) : GH.Util.mergeContent(d, {username: ""}));
                    d = d.replace(/ru=ru2/g, "ru=" + GH.Util.addRU()).replace(/&amp;ru=ru/g,
                        "&ru=" + GH.Util.addRU());
                    GH.userAuth ? (b("#gh-eb-u").html('<button id=gh-ug class="gh-ua gh-control" aria-expanded=false aria-controls=gh-eb-u-o role=button>' + d + '<b class="gh-eb-arw gh-sprRetina"></b></button><div id="gh-eb-u-o" data-view-state="empty" style="display: none;"></div>'), b("#gh-ug").click(function (a, c) {
                        var d = b("#gh-eb-u").data("mo"), f = b("#gh-eb-u").data("t"), g = (new Date).getTime();
                        b("#gh-eb-u").removeData("mo");
                        if (d || !(f && 400 > g - f)) if (a.preventDefault(), b("#gh-eb-u-o").length && "empty" ===
                        b("#gh-eb-u-o").attr("data-view-state")) b("#gh-eb-u-o").remove(), GH.Util.createOverlay("u", 0, c), b("#gh-eb-u-o").data("ghi", 41), GH.Util.openOverlay(b("#gh-ug")), b("#gh-eb-u").addClass("gh-eb-active"), GH.alerts.collectData && GH.Util.cTImg(GH.ghiIMP + 79), ajaxURL = "/gh/user_profile?modules=USER_PROFILE&behavior=GET_PROFILE&moduleType=USER_PROFILE", "HttpClient" in window && (d = new window.HttpClient(ajaxURL, "GET", {
                            correlation: window.trkCorrelationSessionInfo && "function" === typeof window.trkCorrelationSessionInfo.getTrackingCorrelationSessionInfo &&
                                window.trkCorrelationSessionInfo.getTrackingCorrelationSessionInfo()
                        }, null, {shouldRetry: !0, timeout: 1E4}), d.handlers({
                            onload: function (a) {
                                if (a instanceof ProgressEvent && (a = a.target || a.currentTarget, a instanceof XMLHttpRequest)) try {
                                    var b = JSON.parse(a.responseText), d = e.parseResponse(b);
                        ...
                        }), d.initializeAndTrigger()); else e[b("#gh-eb-u-o").is(":hidden") ? "showUserOverlay" : "hideUserOverlay"](c)
                    }), b("#gh-eb-u").hoverIntent({
                        over: function () {
                            b("#gh-eb-u-o").is(":visible") ||
                            (b("#gh-eb-u").data({mo: 1, t: (new Date).getTime()}), b("#gh-ug").click())
                        }, out: function () {
                            e.hideUserOverlay()
                        }, timeout: "500"
                    ...
                    c.r = a && a.feedbackRating &&
                        a.feedbackRating.textSpans && a.feedbackRating.textSpans[1] && a.feedbackRating.textSpans[1].text || "";
                    c.u = a && a.fullName && a.fullName.textSpans && a.fullName.textSpans[0] && a.fullName.textSpans[0].text || "";
                    ...
                    b.ajax(c, {
                        dataType: "jsonp", jsonpCallback: "GH_alertData",
                        timeout: 4E3, success: function (b) {
                    ...
                    var d =
                            GH.Util.getBundle("GreetingsJavascriptContent"), f, g = b("#gh-eb-u-o"), i = 12, j, h,
                    ...
                    typeof e === n && !a || e && e.error && "auth_required" === e.error ? (f = "<div class=gh-o-err><span class=gh-o-errb>" + d.profile_loginUserL10n.replace(/&amp;ru=ru/g, "&ru=" + GH.Util.addRU()) + "</span></div>", g.data("ghi", 40), g.html(f)) : (j = e.r || 0, b.each([10, 50, 100, 500, 1E3, 5E3, 1E4, 25E3, 5E4, 1E5, 5E5, 1E6], function (a, b) {
                        if (j < b) return i = a, !1
                    }), f = e.p ? e.p.replace(/http:.*pics\//, GH.pi) : GH.pi +
                        "social/profile_avatar_60x60.png", h = 77 == GH.C.siteId ? l || k : k || l, f = "<ul id=gh-uu><li id=gh-up><a aria-hidden=true tabindex=-1 _sp=m570.l3331 href='" + GH.Util.getHref(d.profile_myworld).replace("@@", e.d || l) + "'><img id=gh-upi src='" + f + "' alt='" + d.profile_userAltTxt + h + "'></a></li>", f += "<li id=gh-un>" + (e.u || k || "&nbsp;") + "</li><li id=gh-ui>", k = d.profile_myworld.replace('@@"', (e.d || l) + '"_sp=m570.l3332 id="gh-uid"'), k = k.replace("@#@", l + "<i class=gh-ar-hdn>" + d.profile_memberAltTxt + "</i> "), f += k + (!a && GH.userAuth &&
                    "undefined" !== typeof e.r ? " (" + d.profile_feedback.replace('@@"', '"_sp=m570.l3333') + ")" : "") + "</li>", f += "<li id=gh-uac>" + d.profile_accountsettings.replace("href=", "_sp=m570.l3399 href=") + "</li><li id=gh-uo>" + (GH.userAuth ? d.greetingOverlaySignout : d.greetingRecognized.replace(/.*(<a.*a>).*/, "$1").replace(/&amp;ru=ru/g, "&ru=" + GH.Util.addRU())) + "</li></ul>", g.data("ghi", a ? 41 : 39), a && g.addClass("gh-eb-o-err"), g.html(f), c && setTimeout(function () {
                        b("#gh-ui a:first").focus()
                    }, 50), f = b("#gh-uu a[_sp='m570.l3333']").html(j +
                        "<span class='gh-ar-hdn'>" + GH.Util.mergeContent(d.feedbackTitle, {feedback: ""}) + "</span>" + (0 < i ? "<i id=gh-ur role=img style='background-position:" + -[-3, 16, 35, 54, 73, 92, 113, 135, 157, 179, 201, 224][i - 1] + "px " + (7 > i ? "-1px; margin:0 -4px 0 -2px;" : "-2px;") + "' />" : "")), b("#gh-ur").attr("aria-label", d["rating_" + i]), f.attr("href", f.attr("href") + (e.d || l)), f.removeAttr("title"));
    ...
    (function (e) {
        window.GHFlyout = function (j, f, k) {
            ...
            this.addEvents = function () {
                ...
                this.keyboardTriggerElement && (this.keyboardTriggerElement.addEventListener("click", this.keyboardEventHandler.bind(this),
                    !1), this.keyboardTriggerElement.addEventListener("keydown", this.keyboardEventHandler.bind(this), !1));
            ...
            this.triggerShowHideTracking = function (a) {
                var b = a ? "data-show-track" : "data-hide-track", c = null;
            ...
            this.showHideFlyout =
                function (a, b) {
                    var c = e(this.triggerElement), d = c[0].classList.toString(),
                        h = g.querySelectorAll(".gh-acc-exp-a");
                    -1 !== d.indexOf("watchlist-menu") && (a ? h[0] && h[0].setAttribute("tabindex", "-1") : h[0] && h[0].setAttribute("tabindex", ""));
            ...
            this.hideFlyout = function (a) {
                ...
                if (this.isWithinFlyoutDOM(c, this.triggerId + "-flyout") && a && "keydown" !== a.type) a && a.stopPropagation(), clearTimeout(this.hideTimeOut); else {
                    var d = this;
            ...
            this.getFlyoutContent = function () {
                ...
                if ("HttpClient" in window) {
                    ...
                    }, null, {shouldRetry: !1, timeout: 5E3});
                    b.handlers({
                        onload: function (b) {
    ...
    (function (a) {
        var d = {findNegativeTabindex: !0, findPositiveTabindex: !0};
    ...
    (function (a) {
        ...
        a.trapScreenreader = function (e) {
            ...
            var e = (c = a(e)).siblings(":not(script, [aria-hidden=true])"), g = c.parents(":not(html, body)"),
    ...
    ebayContent["GlobalHeaderWeb/CouponJavascriptContent"] = {
        ...
        BL10N: '<a href="https://web.archive.org/web/20230901121114/https://my.ebay.com/ws/eBayISAPI.dll?MyEbayBeta&amp;CurrentPage=Rewards&amp;sspagename=ebaybucksheader"></a>',
        BOL10N: '<a href="https://web.archive.org/web/20230901121114/http://my.ebay.com/ws/eBayISAPI.dll?MyEbayBeta&amp;CurrentPage=Rewards&amp;sspagename=ebaybucksheader#b_offer"></a>',
        JL10N: '<a href="https://web.archive.org/web/20230901121114/https://my.ebay.com/ws/eBayISAPI.dll?RewardsIntEnroll&amp;CTASignup=false&amp;ExtLanding=false&amp;ssPageName=ebaybucksheader"></a>',
        CL10N: '<a href="https://web.archive.org/web/20230901121114/https://my.ebay.com/ws/eBayISAPI.dll?MyeBay&amp;CurrentPage=MyeBayIncentives&amp;gbh=1"></a>'
    };
    ebayContent["GlobalHeaderWeb/NotificationsJavascriptContent"] = {
        zeroAlertsL10n: "You're all caught up!",
        loginAlertL10n: 'Please <a href="https://web.archive.org/web/20230901121114/https://signin.ebay.com/ws/eBayISAPI.dll?SignIn&amp;ru=ru" _sp="m570.l2881">sign-in</a> to view notifications.',
        errorAlertL10n: "Notifications are not available at this time",
        alertHeader: "Notifications",
        dataURL: '<a href="https://web.archive.org/web/20230901121114/http://my.ebay.com/ws/eBayISAPI.dll?GetGHNotificationsCommand"></a>',
        clickURL: '<a href="https://web.archive.org/web/20230901121114/http://my.ebay.com/ws/eBayISAPI.dll?SetGHNotificationsReadTSCommand"></a>',
        ...
        proxyURL: '<a href="https://web.archive.org/web/20230901121114/http://gha.ebay.com"></a>',
        latestproxyURL: '<a href="https://web.archive.org/web/20230901121114/http://www.gha.pp.stratus.ebay.com"></a>'
    };
    ebayContent["GlobalHeaderWeb/SYMBAnJavascriptContent"] = {
        ...
        loginAlertL10n: '<a href="https://web.archive.org/web/20230901121114/https://signin.ebay.com/ws/eBayISAPI.dll?SignIn&amp;ru=ru" _sp="m570.l2881">Please <span>sign-in</span> to view notifications.</a>'
    };
    ...
    GH.GHN_SURVEY_HTML = "";
    GH.GH_NOTIF_TMPL_LINK = "https://web.archive.org/web/20230901121114/https://ir.ebaystatic.com/cr/v/c1/c4ca4238a0b923820dcc509a6f75849b4.js";
    (function () {
    ...
    function GHalertObj(e, Ua, Va) {
        var c = e.jQ, P = Va(Ua, c), g = GHalertObjData(c, P), pa = g.isNewDataValid, Ea = g.setNextURL,
            G = g.getNextURL, Wa = g.getItemKey, x = g.getUniqueId, Fa = g.getItemId, Ga = g.getItemEndTime,
            Xa = g.isDuplicate, qa = g.setItemStatus, ra = g.isNewOrPopUp, Q = g.loadMoreNotifs, Ya = g.getItemKeyName,
            Ha, B, t, Ia, i = null, ba = "", ca = "", C = null, R = null, Ja = null, H = 0, Za = P.Const, m = g.conf,
            $a = m.GHlocalStorage, o = m.undefinedStr, n = P.Util, p = P.Tracking(m, g), ab = P.Storage, bb = Za.TITLE,
            sa = m.newalertsasync, da = m.design, u = {
            ...
            ea = {2: e.Util.addSignin(y.loginAlertL10n), 4: y.zeroAlertsL10n, 6: y.errorAlertL10n, 3: y.errorAlertL10n},
            I = m.alertURL, ta = "0", fa = m.refreshAllDataFlag, f = m.polling, ua = f.secWaitActivity, ga = {},
            d = null, U = [], l = null, va = null, V = 0, r = {}, ha = {}, w = !1, wa = !1, W = !1, ia = null, s = null,
            D = {}, J = {}, La, q = 0, X = -1, K = -1, xa = !1, Y = !1, ja = !1,
            eb = void 0 !== y.survey ? y.survey : "", Ma = e.GHN_SURVEY_HTML ?
            ...
            j = $a && n.isLocalStorageSupported && Na ? ab : null, Z = !1, A = function (a) {
                ...
                if (w) if (Ja()) A(3); else {
                    ...
                    f.countPolling++;
                    if (0 === f.countPolling % f.intervalRefreshData || fa) if (void 0 === fa || fa) X = -1, ta = "1";
                ...
                var a = 30, b = typeof f !== o ? f.pollingFrequency : 0;
            ...
            Ra = function (a) {
                ...
                n.getTimeDiff(h) == n.tlf.e ? Ra(a) : (g.isBidFlag(a) && (f.bidFlag = !0), r["" + b] = {
                    id: setInterval(function () {
                        ...
                        if (e == n.tlf.e) if (Ra(a), clearInterval(r["" + b].id), delete r["" + b], c.isEmptyObject(r)) f.bidFlag = !1; else for (d in f.bidFlag = !1, r) if (g.isBidFlag(r[d].item)) {
                            f.bidFlag = !0;
                            break
                        }
                    }, 1E3), item: a
                ...
                "true" !== e.GHSW.NEWALERT_POPUPOFF && g.isPopUp(a) && (c(ba + ca).length ? setTimeout(function () {
                    ...
                    var b = a, k = $(b, 2), k = c("<div class='ghn-pop-wrap'>" +
                        k + "</div>"), h = "#ghn-pop-" + x(b), d = !1, f = !1;
                    e.Util.cTImg(e.ghiIMP + 54 + "&_trkparms=" + p.rowTrack("gh1g", b));
                    0 < c(h).length && c(h).parent().hide("slow").remove();
                    c(ba + ca).length ? O() : (c(k).appendTo("body"), c.fn.ghellipsis && c(h + " .ghn-desc-o").ghellipsis({row: 2}), c(k).css({top: u.position + "px"}).animate({right: "0px"}, function () {
                        c(ba + ca).length && O()
            ...
            O = function (a) {
                ...
                var b = y.many, k = ("" + a).length, k = 3 < k ? 3 : k, h = i && i.ghEBAlerts_id || this.ghEBAlerts_id,
                    g = i && i.ebAClass || this.ebAClass, d = "undefined" === typeof newNotifFlag ? 0 < k : newNotifFlag;
                c(h + " i.ghn-num").remove();
                a ? (c(h + " " + g).append("<i aria-hidden='true' " + (d ? "class='ghn-new ghn-num'" : "class=' ghn-num'") +
                    " id=gh-eb-Alerts-n" + k + ">" + (99 < a ? "99+" : a) + "</i>"), 1 == a && (b = y.one), b = e.Util.mergeContent(b, {itemcount: a})) : (k = 0, b = y.zero);
                ...
                var k, h, f, i = "", j = c.isArray(a) ? !1 : !0, m = "%26", o = !1, l = c(t + " li").length;
                s = a;
                if (j) {
                    if (!pa(a)) return;
                ...
                v(!0, !0);
                !1 !== b && (0 < i.length &&
                (c(t).append(i), c.fn.ghellipsis && c(B).is(":visible") && c(".ghn-desc-o").ghellipsis({row: 2}), o && (e.Util.cTImg(e.ghiIMP + 5 + m), p.overlayLastIdxSojDropped = l)), c(".ghn-i").each(function (a, b) {
                    n.createImage(b)
                }))
            }, z = function (a) {
                var b = "", k = "%26", h = 0, f = B, b = 0, j = i.overlayTemplate;
                ...
                Y = !1;
                s = a;
                if (b || g.isHandleNotifNeedUpdated(a)) if (Pa(), pa(a)) if (g.isZeroData(a) ? (h = !0, b ? v(!1) : v(!0, !1), f.zeroFlag = !0) : f.zeroFlag = !1, a = g.convertItemType(a), b || (Ea(a.next), U = [], void 0 !== G() && (g.getIsScrollEventAdded() || g.addScrollEvent())), void 0 !== g.handleNewNotif && (a = g.handleNewNotif(a, d)), h) C() && !R() && z(); else {
                    d = a;
                ...
                null === ia && (null === d && !w && !wa && !W ? V ? setTimeout(function () {
                    ...
                    i || j()
                }, 2500)) : e.Util.loadScript(e.NotificationsMock.mockDataUrl,
        ...
        return {
            ...
            init: function () {
                ...
                if (e.userRecog) {
                    ...
                    if (null === j) if (sa) a(!0); else c(window).on("load.gh", function () {
                        a(!1)
                    }); else {
                        var b = j.timestamp - n.getCurrentTime();
                        if (0 >= b || e.NotificationsMock) if (sa) a(!0); else c(window).on("load.gh", function () {
                            a(!1)
                        });
                        else {
                            ...
                            if (sa) {
                                var f = n.getCurrentTime() - d, b = b - f;
                                A(b)
    ...
    function GadgetNotification(m, f, l, b) {
        var c = m(b).require("AlertObj", [f, l]), j = f.ghEBActive_id, m = "." + j, i = b("#gh-eb-Alerts"), n = !1,
            o = 0;
        onRemoveNotiifcation = function (a, e) {
            ...
            g = b(d).closest("li");
            if ("none" === b(d).find("i").css("display")) return a.stopPropagation(), a.preventDefault(), g.find("a.ghn-a-itm").trigger(a.type),
                !1;
            if (g.find(".ghn-confirm").length) b(d).closest("li").find(".ghn-a-itm").addClass("disable").end().find(".ghn-desc").hide().end().find(".ghn-confirm").show(); else {
                var e = g.attr("data-uid") || li.attr("data-id"), h = g.attr("data-groupid");
                a.preventDefault();
                c.clickconfirmButton(function () {
                    var a;
        ...
        addEventOnOverlay = function () {
            ...
            i.delegate("#gh-eb-Alerts-o a.ghn-a-itm",
                "click touchend", function (a) {
                    var e = b(this).parent(), d = e.attr("data-uid"), g = e.attr("data-id");
                    void 0 === d && (d = g);
                    a.preventDefault();
        ...
        var l = {addEvent: addEvent}, p = function (a, e) {
            25 < e ? b("#gh-eb-Alerts .gh-control").focus() : setTimeout(function () {
                var d = b("#gh-eb-Alerts-o a:first"), c = b("#ghn-err");
                d.length ? d.focus() : c.length ? b("#ghn-err").focus() : (e++, p(a, e))
            }, a)
        };
        return b.extend(c, {
            triggerViewTracking: function (a) {
                var e = f && f.C && f.C.pageId || "2380424", d = JSON.parse(JSON.stringify({
                    eventFamily: "NOTF",
                    eventAction: "VIEW",
                    operationId: "",
                    flushImmediately: !1,
                    eventProperty: {sid: "", moduledtl: "mi:1", trkp: ""}
                }));
                d.operationId = e;
                d.eventProperty.sid =
                    "p" + e + ".m1";
            ...
            makeGadgetCall: function (a) {
                var b = this;
                if ("HttpClient" in window) {
                    var d = new window.HttpClient("/gh/globalheaderonload?modules=NOTIFICATION_DWEB_OVERLAY_CONTENT&skipimp=true", "GET", {correlation: window.trkCorrelationSessionInfo && "function" === typeof window.trkCorrelationSessionInfo.getTrackingCorrelationSessionInfo && window.trkCorrelationSessionInfo.getTrackingCorrelationSessionInfo()},
                        null, {shouldRetry: !1, timeout: 5E3});
                    d.handlers({
                        onload: function (d) {
            ...
            addShowEventOnOverlay: function () {
                ...
                a.hoverIntent({
                    over: function () {
                        ...
                        var e = new CustomEvent("NOTIFICATION_OVERLAY_OPENED", {detail: "userHoverOver"});
                        document.dispatchEvent(e)
                    }, out: function () {
                        c.removeItem();
                        c.closeOverlay(a);
                        window.gadgetNotificationOverlayVisible =
                            !1;
                        var b = new CustomEvent("NOTIFICATION_OVERLAY_CLOSED", {detail: "userHoverOut"});
            ...
            openOverlay: function (a, e, d) {
                ...
                b.fn.ghellipsis && (b.fn.ghellipsisDetails && b(e).is(":visible")) && b(".ghn-desc-o").ghellipsis({row: 2});
                b.fn.ghellipsisDetails && b(e).is(":visible") && b(".ghn-desc__min_details ").ghellipsisDetails({row: 2});
                a.addClass(j)
            },
            ...
            return {
                init: function () {
                    ...
                    if (a.length) {
                        ...
                        c && (c = GH.Util.mergeContent(c, {itemcount: b}), cartObj.attr({alt: c, "aria-label": c}));
    ...
    ebayContent["GlobalHeaderWeb/AutocompleteJavascriptContent"] = {
        ...
        acCatalog: '<a href="https://web.archive.org/web/20230901121114/http://www.ebay.com/ctg/?_pid=#P#&amp;_trksid="></a>',
    ...
    (function (b) {
        function h(f, c) {
            b.ajax(f, {
                dataType: "jsonp", cache: !0, jsonp: !1, complete: c, error: function (b) {
                    200 != b.status && GH.Util.cTImg(GH.ghiIMP + 30)
                }
            })
        }
        ...
        var k = {
            _0: {domain: "ebay.com"},
            _210: {domain: "ebay.ca", hasSubdomain: !0, cc: "cafr"},
            _123: {domain: "ebay.be", hasSubdomain: !0, cc: "benl"},
            _23: {domain: "ebay.be", hasSubdomain: !0, cc: "befr"},
            _101: {domain: "ebay.it", cc: "it"},
            _203: {domain: "ebay.in", cc: "in"},
            _15: {domain: "ebay.com.au", cc: "au"},
            _193: {domain: "ebay.ch", cc: "ch"},
            _201: {domain: "ebay.com.hk", cc: "hk"},
            _2: {
                domain: "ebay.ca",
                cc: "ca"
            },
            _186: {domain: "ebay.es", cc: "es"},
            _3: {domain: "ebay.co.uk", cc: "uk"},
            _146: {domain: "ebay.nl", cc: "nl"},
            _71: {domain: "ebay.fr", cc: "fr"},
            _205: {domain: "ebay.ie", cc: "ie"},
            _16: {domain: "ebay.at", cc: "at"},
            _211: {domain: "ebay.ph", cc: "ph"},
            _77: {domain: "ebay.de", cc: "de"},
            _207: {domain: "ebay.com.my", cc: "my"},
            _212: {domain: "ebay.pl", cc: "pl"},
            _216: {domain: "ebay.com.sg", cc: "sg"}
        };
        GH.add("SearchBox_AutoComplete", function () {
            var f;
            return {
                acDisabledClass: "gh-acHidden", init: function (c) {
                    function i() {
                        b(this).unbind("focusin keydown",
                            i);
                        window.performance && window.localStorage && (localStorage.removeItem("ac_first_interact_timer"), performance.mark("ac_first_interact_timer_start"))
                    }

                    var d = GH.vCJar, g = GH.Util.getBundle("AutocompleteJavascriptContent");
                    f = this;
                    if (!c && d && 1 == d.getBitFlag(d.readCookie("dp1", "pbf"), 29)) b(GH.ghAC_id).after("<a id=ghAC-show class='gh-spr icas' title='" + g.acShowSuggestions + "' href='#'></a>"), b(GH.componentID).addClass(f.acDisabledClass), b(GH.ghAC_id).attr({
                        autocomplete: "on",
                        "aria-haspopup": "false"
                    }).removeAttr("autocapitalize autocorrect spellcheck"),
                        b("#ghAC-show").bind("click", function (a) {
                            var c, d = GH.vCJar;
                            a.preventDefault();
                            d && (a = d.readCookie("dp1", "pbf"), d.writeCookielet("dp1", "pbf", d.setBitFlag(a, 29, 0)));
                            b(GH.componentID).removeClass(f.acDisabledClass);
                            GH.Util.cTImg("/roverclk/0/0/9?trknvp=sid%3D" + GH.Util.cTId("1315"));
                            GH.SearchBox_AutoComplete.init(!0);
                            b("#ghAC-show").remove();
                            b(GH.ghAC_id).mouseenter();
                            c = function () {
                                typeof b(GH.ghAC_id).autocomplete == GH.functionStr ? b(GH.ghAC_id).autocomplete("search").focus() : setTimeout(c, 300)
                            };
                            setTimeout(c,
                                300)
                        }); else {
                        b(GH.ghAC_id).bind("focusin keydown", i);
                        var e = window.localStorage, c = e.getItem("autocomplete_dweb_last_updated"),
                            d = e.getItem("autocomplete_dweb_url");
                        if (c && d && 18E5 > Date.now() - c) h(d); else {
                            var c = window.location.origin, a = window.GH.Util.getSiteID(), d = /localhost/.test(c),
                                g = /\.stratus\.qa\./.test(c), l = /\.qa\./.test(c), m = /\.latest\./.test(c),
                                a = k["_" + a],
                                j = (g ? c : l || d ? a && a.cc ? "https://web.archive.org/web/20230901121114/https://www." + a.cc + ".paradise.qa.ebay.com" : "https://web.archive.org/web/20230901121114/https://www.qa.ebay.com" : m ? a && a.hasSubdomain ? "https://web.archive.org/web/20230901121114/https://www." + a.cc + ".latest." + a.domain :
                                    a ? "https://web.archive.org/web/20230901121114/https://www.latest." + a.domain : "https://web.archive.org/web/20230901121114/https://www.latest.ebay.com" : a && a.hasSubdomain ? "https://web.archive.org/web/20230901121114/https://www." + a.cc + "." + a.domain : a ? "https://web.archive.org/web/20230901121114/https://www." + a.domain : "https://web.archive.org/web/20230901121114/https://www.ebay.com") + "/sch/ajax/autocomplete";
                            b.ajax(j, {
                                xhrFields: {withCredentials: !0}, success: function (a) {
                                    try {
                                        var c = a.url, b = a.activeFactors;
                                        c && b && (e.setItem("autocomplete_dweb_last_updated", Date.now()), e.setItem("autocomplete_dweb_url", c), e.setItem("autocomplete_active_factors", JSON.stringify(b)), h(c, function () {
                                            if (window.performance && performance.getEntriesByName) {
                                                var a =
                                                        performance.getEntriesByName(j)[0],
                                                    b = performance.getEntriesByName(c)[0];
                                                a && b && (e.setItem("ac_loader_timer", a.duration), e.setItem("ac_js_timer", b.duration))
                                            }
                                        }))
                                    } catch (d) {
                                        console.error(d)
    ...
    ebayContent["GlobalHeaderWeb/InflowJSContent"] = {url: '<a href="https://web.archive.org/web/20230901121114/http://www.ebay.com/ifh/inflowcomponent?callback=Inflow.cb"></a>'};
    (function () {
        GH.add("Inflow", function () {
            return {
                init: function () {
                    window.addEventListener("load", function () {
                        var a = document.getElementById("gh-ihelp"), a = a && "" !== a.innerHTML ? a.innerHTML : "{}",
                    ...
                    for (var a =
                        1; a < arguments.length; a++) for (var b in arguments[a]) arguments[a].hasOwnProperty(b) && (arguments[0][b] = arguments[a][b]);
                    return arguments[0]
    ...
    ebayContent["GlobalHeaderWeb/BackToTopJavascriptContent"] = {arrowImage: '<img title="Scroll to top" src="https://web.archive.org/web/20230901121114/http://ir.ebaystatic.com/pictures/aw/pics/globalheader/btt.png" alt="Scroll to top" border="0" height="76" width="33" _id="gh-bti"/>'};
    (function (c) {
        ...
        GH.add("PulsarPolyfill", function () {
            return {
                init: function () {
                    ...
                    var i = "object" === typeof _plsUBTTQ, h = !1;
                    try {
                    ...
                    var g =
                        {eventAction: "eactn", eventFamily: "efam", operationId: "cp"};
...
/*
     FILE ARCHIVED ON 12:11:14 Sep 01, 2023 AND RETRIEVED FROM THE
...
/*
playback timings (ms):
  captures_list: 86.165
  exclusion.robots: 0.083
  exclusion.robots.policy: 0.073
  cdx.remote: 0.062
  esindex: 0.009
  LoadShardBlock: 47.746 (3)
  PetaboxLoader3.datanode: 125.406 (4)
  load_resource: 1914.086
  PetaboxLoader3.resolve: 58.82
*/
