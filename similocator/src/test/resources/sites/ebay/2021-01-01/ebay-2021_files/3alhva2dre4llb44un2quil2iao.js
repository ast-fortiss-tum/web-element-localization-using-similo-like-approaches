...
}
{
    ...
    !function (j, l) {
        ...
        var l = function (a, d) {
            if (!(a instanceof
                d)) throw new TypeError("Cannot call a class as a function");
        }, i, o = function (a, d) {
        ...
        g = (i(h, [{
            ...
            key: "sanitizeRequestUrlByEnv", value: function (a) {
                if (a) {
            ...
            key: "addQueryParam", value: function (a) {
                var b = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {},
                    e = Object.assign({}, this.URL_QUERY_MAP), e = Object.assign(e, b),
                    e = Object.assign(e, {v: this.VERSION}), b = Object.keys(e);
                return b.length && (a = b.reduce(function (a, b) {
                    var d = e[b];
                    if (d) var h = -1 < a.indexOf("?") ? "&" : "?", a = a + h + b + "=" + encodeURIComponent(d);
                    return a
        ...
        },
            {
                ...
                key: "ENV_ENUM", get: function () {
                    return {PRODUCTION: "production", DEV: "dev"}
                }
            }]), h);
        var a = function () {
            var d = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : "/gh/useracquistion",
                ...
                f = 4 < arguments.length && void 0 !== arguments[4] ? arguments[4] : {
                    timeout: 5E3, shouldRetry: !1,
                    async: !0, maxRetries: 1, hasFullXhrUrl: !1
                }, m = f.timeout, m = void 0 === m ? 5E3 : m, g = f.shouldRetry, g = void 0 !== g && g, i = f.async,
                i = void 0 === i || i, j = f.maxRetries, j = void 0 === j ? 1 : j, f = f.hasFullXhrUrl,
                f = void 0 !== f && f,
    ...
    ebayContent["GlobalHeaderWeb/GHJavascriptContent"] = {
        ...
        signinURL: '<a href="https://web.archive.org/web/20210101121235/https://signin.ebay.com/ws/eBayISAPI.dll?SignIn"></a>',
        errL10n: "Sorry, this feature is currently not supported on this page",
        roverurl: '<a href="https://web.archive.org/web/20210101121235/http://rover.ebay.com"></a>',
    ...
    (function (c) {
        if ("undefined" !== typeof c && ("undefined" === typeof GH || !GH)) {
            ...
            GH = {
                ...
                isMweb: !1,
                Events: {
                    eventsList: {}, publish: function (a, b) {
                ...
                init: function () {
                    ...
                    var e = function (a) {
                        ...
                        for (b in GH.CompConstructors) if (GH[b]) {
                            var a = null;
                    ...
                    "complete" === document.readyState || "interactive" === document.readyState ? setTimeout(f) : document.addEventListener ?
                        document.addEventListener("DOMContentLoaded", e, !1) : document.attachEvent("onreadystatechange", e)
                },
                windowLoad: function () {
                    var a;
                    if (!GH.windowLoaded) for (objName in GH.windowLoaded = !0, GH.CompConstructors) try {
    ...
    (function (c) {
        GH.add("Util", function () {
            var l, n, q = GH.L10N, s = GH.GHSW, r = GH.isDefined, t = GH.sec, p = {}, o;
            ...
            return {
                sec: t, geo: !1, getPageID: function () {
                    return GH.C.pageId
                },
                getSiteID: function () {
                    return GH.C.siteId
                    ...
                    if (2046732 == n || 2045573 == n || 2334524 == n) {
                        var a = c(GH.SearchBox.formID + " input[name=LH_TitleDesc]"),
                            b = window.location.href, d = c("#gh-as-a"), e, h, f;
                ...
                getBundle: function (a) {
                    ...
                    return e.join("")
                }, browser: c.browser, whichBrowser: function () {
                    ...
                    var b = document, d = b.getElementById("gh-svyForm"), a = c(a.currentTarget);
                    ...
                    var d = "#gh-eb-" + a, e = c(d + " .gh-eb-li-a").outerWidth() - 8;
                    GH.Util.hideOverlays();
                    ...
                    var e = "#gh-eb-" + a, h = c(e + " .gh-eb-li-a").outerWidth() - 8;
                    GH.Util.hideOverlays();
                    c(e).append("<div id=gh-eb-" + a + "-o class='gh-eb-o'" +
                        (b ? " aria-busy=true aria-live=polite" : "") + " style='" + (180 < h ? "min-width:" + h + "px" : "") + "'><div class=gh-o-l " + (d ? "tabindex=0" : "") + " >" + GH.L10N.msg_loading + "</div></div>");
                    ...
                    d && (c = "");
                    d = RegExp(c + "http:");
                    GH.sec && (a = a.replace(d, "https:"), b && (b = RegExp(c + "https://web.archive.org/web/20210101121235/https://ir."), c = RegExp(c + "https://web.archive.org/web/20210101121235/https://pics."), a = a.replace(b, "https://web.archive.org/web/20210101121235/https://secureir."), a = a.replace(c,
                        "https://web.archive.org/web/20210101121235/https://securepics.")));
                    return a
                }, addPrefixPoolURL: function (a) {
                    var b = GH.GHSW.pool ? GH.GHSW.pool : null, d = c.isArray(a), e = "string" === typeof a,
                        h = [0, 31, 215, 248, 223], f = GH.siteSpecific.maprules.regex,
                    ...
                    c("body").append('<img src="' +
                        GH.Util.getRoverUrl() + a + (0 < a.indexOf("?") ? "&" : "?") + (new Date).getTime() + '" width=1 height=1 border=0 alt="">')
                    ...
                    var b = "", d, c, h, f, j, k = 0, m = a.length;
                    if (/[^A-Za-z0-9\+\/\=\*]/g.exec(a)) return "";
                    for (; k < m;) d = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=*".indexOf(a.charAt(k++)),
                        c = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=*".indexOf(a.charAt(k++)), f = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=*".indexOf(a.charAt(k++)), j = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=*".indexOf(a.charAt(k++)), d = d << 2 | c >> 4, c = (c & 15) << 4 | f >> 2, h = (f & 3) << 6 | j, b += String.fromCharCode(d), 64 <= f || (b += String.fromCharCode(c)), 64 <= j || (b += String.fromCharCode(h));
                    return b
                ...
                loadScript: function (a, b) {
                    var b = "undefined" !== typeof b ? b : !0, d, c, h, f = document.createElement("iframe");
                    d = (new Date).getTime();
                    b && (a = a + "&_=" + d);
                    ...
                    var a = GH, b = {COOKIELET_DELIMITER: "^", NAME_VALUE_DELIMITER: "/", escapedValue: !0},
                        c = {COOKIELET_DELIMITER: "^", NAME_VALUE_DELIMITER: "/", bUseExp: !0, startDelim: "b"},
                        e = {COOKIELET_DELIMITER: "^", NAME_VALUE_DELIMITER: "=", escapedValue: !0, startDelim: "^"},
                        h = {
                            reg: ["dp1", "reg"],
                            recent_vi: ["ebay", "lvmn"],
                            ebaysignin: ["ebay", "sin"],
                        ...
                        j = -1 < document.domain.indexOf(".ebay.") ? document.domain.substring(document.domain.indexOf(".ebay.")) : ".ebay.com";
                    a.vCJar = {
                        readCookie: function (a, m) {
                            ...
                            var g = m && m.match(/guid$/), c = "undefined" != typeof b ? b : "";
                            c && (g && 32 < b.value.length) && (b.value = b.value.substring(0, 32));
                            return c
                        }, checkConversionMap: function (a) {
                            var b = h[a.name];
                            b && (a.mode =
                                this.getMode(a.name), a.name = b[0], a.cookieletname = b[1])
                            ...
                            if (a && void 0 !== b && (isNaN(b) && 4E3 > b.length || 4E3 > (b + "").length)) {
                                ...
                                var g = c ? new Date(c) : new Date(this.getExpDate(730)), d = this.getFormat(a);
                                document.cookie && (document.cookie = a +
                                    "=" + (b || "") + (c || d.bUseExp ? "; expires=" + g.toGMTString() : "") + "; domain=" + j + "; path=/")
                            }
                        }, writeCookieEx: function (a, b, c) {
                            this.writeCookie(a, b, this.getExpDate(c))
                        }, writeCookielet: function (a, b, c, g, d) {
                            a && b && (this.update(), this.getFormat(a).bUseExp && c && ("number" == typeof g && (g = this.getExpDate(g)), g = g ? new Date(g) : new Date(this.getExpDate(730)), g = Date.UTC(g.getUTCFullYear(), g.getUTCMonth(), g.getUTCDate(), g.getUTCHours(), g.getUTCMinutes(), g.getUTCSeconds()), g = Math.floor(g / 1E3), c += parseInt(g, 10).toString(16)),
                                b = this.createCookieValue(a, b, c), this.writeRawCookie(a, b, d))
                            ...
                            var c = parseInt(a, 10), g = c.toString(2);
                            ...
                            b = g.length - b - 1;
                            return parseInt(g.substring(0,
                                b) + c + g.substring(b + 1), 2)
                        }, getBitFlag: function (a, b) {
                            if (null != a && 0 < a.length && "#" == a.charAt(0)) {
                                var c = b % 4, g = a.length - (Math.floor(b / 4) + 1),
                                    g = parseInt(a.substring(g, g + 1), 16), c = 1 << c;
                                return (g & c) == c ? 1 : 0
                            }
                            return this.getBitFlagOldVersion(a, b)
                        }, setBitFlag: function (a, b, c) {
                            if (null != a && 0 < a.length && "#" == a.charAt(0)) {
                                var g = a.length, d = b % 4, b = Math.floor(b / 4) + 1;
                                if (g <= b) {
                                    if (1 != c) return a;
                            ...
                            var d = h[a], e = this.getFormat(a), f = this.getMode(a),
                                a = d && ("00" == f || "01" == f) ? this.readCookieObj(d[0], d[1]).value || "" : this.aCookies[a] || "";
                            if (e) {
                                a = this.getCookieletArray(a, e);
                                a[b] = c;
                                var b = "", j;
                                for (j in a) a.hasOwnProperty(j) && (b += j + e.NAME_VALUE_DELIMITER + a[j] + e.COOKIELET_DELIMITER);
                        ...
                        update: function () {
                            ...
                            if (0 === b) return "00";
                            if (b && "0" != b) {
                                if (-1 != b.indexOf(".")) for (var d =
                                    b.split("."), b = 0; b < d.length; b++) c = parseInt(d[b], 16).toString(2) + c; else c = parseInt(b, 16).toString(2);
                                var b = 0, d = c.length, e, f;
                                for (f in h) {
                                    e = d - 2 * (b + 1);
                            ...
                            var e = 0, f, d = d.toString(2).substring(0, c);
                            f = d.length;
                            if (f < c) {
                                c -= f;
                                for (e = 0; e < c; e++) d = "0" + d;
                    ...
                    if (GH.oldDT && !r("noStandardCSS")) {
                        var a = "ebay", b = "forums. chatboards answercenter http://vi. http://ivi. events.".split(" "),
                            d = !1;
                        for (i = 0; i < b.length; i++) if (-1 < document.domain.indexOf(b[i])) {
                            d = !0;
                            break
                        }
                        if (r("nodefaultcss") || d) a += "-nodefault";
                        if (GH.Util.browser.mozilla || GH.Util.browser.webkit || GH.isIE && d) a += "-ns";
                        a = (l.sec ? "https://web.archive.org/web/20210101121235/https://secureinclude" : "https://web.archive.org/web/20210101121235/http://include") + ".ebaystatic.com/css/v/us/legacy/" +
                            a + ".css";
                        c.getCSS(a)
                    }
                    ...
                    c.cachedScript = function (a) {
                        return c.ajax({dataType: "script", cache: !0, url: a})
                    };
                    c.fn.scrollLock = function (a) {
                        if (c.isFunction(c.fn.on)) return c(this).on("DOMMouseScroll." + a + " mousewheel." + a, function (a) {
                            var d = c(this), e = this.scrollTop, h = this.scrollHeight, f = d.height(),
                                j = "DOMMouseScroll" ==
                                a.type ? -40 * a.originalEvent.detail : a.originalEvent.wheelDelta, k = 0 < j,
                                m = function () {
                                    a.stopPropagation();
                                    a.preventDefault();
                    ...
                    c.fn.ghellipsis = function (a) {
                        ...
                        this.each(function () {
                            var b = c(this), d = b.text(), e = b.height();
                            if (!b.hasClass("ghellip")) {
                                b.addClass("ghellip");
                                b.text("a");
                                var h = parseFloat(b.css("lineHeight"), 10), f = b.height(),
                                    h = (h > f ? h - f : 0) * (a.row - 1) +
                                        f * a.row;
                    ...
                    c.fn.ghellipsisDetails = function (a) {
                        a = c.extend({
                            row: 1, "char": "...", callback: function () {
                            }
                        }, a);
                        this.each(function () {
                            var b = c(this), d = b.parent(), e = b.text(), h = e, f = b.height();
                            if (!b.hasClass("ghellip")) {
                                b.addClass("ghellip");
                                b.text("a");
                                var j = parseFloat(d.css("lineHeight"), 10), k = d.height() - 2, j = j > k ? j - k : 0;
                                Math.floor(f) >= Math.floor(k) && (b.parents(".coupon-itm").addClass("coupon-itm__tall-details"), b.text(h), f = d.height(), b.text("a"));
                                k = d.height();
                                k = j * (a.row - 1) + k * a.row;
                                if (f <= k) b.text(e); else {
                                    for (var f = 1, j = 0, m = e.length; f < m;) j = Math.ceil((f + m) / 2), b.text(e.slice(0, j) + a["char"]), d.height() <= k ? f = j : m = j - 1;
                                    e = e.slice(0, f);
                                    e += a["char"];
                                    b.text(e);
                                    b.prop("title", h)
                    ...
                    c.fn.hoverIntent = function (a, b) {
                        var d,
                            e, h, f, j = function (a) {
                                d = a.pageX;
                                e = a.pageY
                            }, k = {sensitivity: 15, interval: 100, timeout: 150}, m = function (a, b) {
                                ...
                                var b = jQuery.extend({}, a), d = this;
                                d.hoverIntent_t && (d.hoverIntent_t = GH.Util.clrTimer(d.hoverIntent_t));
                                "mouseover" == a.type ? (h = b.pageX, f = b.pageY, c(d).bind("mousemove",
                                    j), 1 != d.hoverIntent_s && (d.hoverIntent_t = setTimeout(function () {
                                    m(b, d)
                            ...
                            }, k = c.extend(k, b ? {over: a, out: b} : a);
                        return this.bind("mouseover", l).bind("mouseout", l).bind("focusin", function (a) {
            ...
            return {
                init: function () {
                    ...
                    [{
                        ...
                        actionKind: "CLICK",
                        eventFamily: "GBHEADER"
                    }, {selector: "#gh", dropEvent: "scroll", eventFamily: "GBHEADER"}].forEach(function (a) {
                        var d = a.dropEvent, b = document.querySelector(a.selector);
                        if (b) {
                            var h = b.getAttribute("data-treatment"), j = b.getAttribute("data-sp") || null,
                                i = a.actionKind, k = a.eventFamily, e = "p" + c;
                            j && (e += ".m" + j);
                            var l = !1, m = function () {
                                ...
                                if (h && !(l || 100 > window.pageYOffset)) {
                                    ...
                                    var a = [{
                                        actionKind: i,
                                        eventFamily: k, eventAction: "ACTN", eventProperty: {sid: e, xt: h}
                                    }, {actionKind: "VIEW"}];
                                    console.debug("Sending to pulsar:", JSON.stringify(a));
                                    g(document).trigger("pulsar", a);
        ...
        GH.add("TopBar", function () {
            ...
            return {
                addCSSShadow: function () {
                    ...
                    var c = document.body.style, f = window.getComputedStyle, d;
                    b(GH.componentID).removeClass("gh-pre-js");
                    var a = GH.GHSW, a = "undefined" !== typeof a && "true" === a.SEARCH_PROM;
    ...
    ebayContent["GlobalHeaderWeb/FooterJavascriptContent"] = {
        mftrLinkURL: '<a href="https://web.archive.org/web/20210101121235/http://www.m.ebay.com"></a>',
        mftrLinkURLUnified: '<a href="https://web.archive.org/web/20210101121235/http://www.ebay.com"></a>'
    };
    (function (a) {
        GH.add("Accessibility", function () {
            return {
                init: function () {
                    var c = a("h1:not(#gh-l-h1):first"), e = a("[name=mainContent]"), f = a("#mainContent");
                    ...
                    a(".gh-acc-exp-a").click(function () {
                        var b = a(this).closest("li"), d = b.closest("li").attr("data-imp");
            ...
            return {
                init: function () {
                    ...
                    !e.hideMobile && (GH.userAgent.match(/android.*mobile|bntv|blackberry|bb10|webos|iemobile|silk|cloud9|iphone/i) &&
                        !GH.userAgent.match(/kindle|Nexus 7|NOOK|BNTV/i)) && a.cachedScript(GH.Util.getSecURL("https://web.archive.org/web/20210101121235/http://ir.ebaystatic.com/f/logwisyb5e5yddn4zmlg5mnhbab.js", !0));
                    ...
                    a("#gf-f").bind("keydown", function (c) {
                        var f = c.keyCode ? c.keyCode : c.charCode, d = a("#gf-f a").get(), b = c.target;
    ...
    (function (a) {
        GH.add("ShopByCat", function () {
            ...
            return {
                controlID: "#gh-shop-a", init: function () {
                    b = this;
                    ...
                    a("#gh-shop").hoverIntent({
                        ...
                        }, sensitivity: 30, interval: 100, timeout: 150
                    });
                    ...
                    var a = ['<table id="gh-sbc" role="presentation"><tbody><tr>'], b = 0, h, g = [];
                    GH.getShopByCatData &&
                    (h = GH.getShopByCatData(), g = GH.Util.addPrefixPoolURL(h.data), h = h.itemsPerColumn || 3);
                    for (var n = 0, m = g.length; n < m; n++) {
                        var k = g[n], c = k.parent, e = c.id, j = c.title || "", d = c.url || "javascript:;", l = c.txt,
                            f = c.sp ? "_sp=" + c.sp : "", o = c.id ? "id=" + c.id : "";
                        ...
                        if (e && ("gh-shop-col-link" == e || "gh-shop-see-all" == e || "gh-shop-see-all-center" == e || "gh-shop-by-brand" == e || "gh-shop-by-sale" == e)) a.push('<h3 class="gh-sbc-parent"><a title="' +
                            j + '" href="' + d + '" ' + f + " " + o + ">" + l + '<i class="gh-sbc-h3i gh-sprRetina"></i></a></h3>'); else {
                            0 == b % h && (e = "</td><td>", 0 == b && (e = "<td>"), a.push(e));
                            a.push('<h3 class="gh-sbc-parent">' + (c.url ? '<a title="' + j + '" href="' + d + '" ' + f + " " + o + ">" + l + '<i class="gh-sbc-h3i gh-sprRetina"></i></a>' : l) + "</h3>");
    ...
    GH.getShopByCatData = function () {
        return {
            data: [{
                parent: {
                    sp: "m570.l3410",
                    url: "https://web.archive.org/web/20210101121235/https://www.ebay.com/b/Collectibles-Art/bn_7000259855",
                    txt: "Collectibles & art"
                },
                children: [{
                    sp: "m570.l3638",
                    url: "https://web.archive.org/web/20210101121235/https://www.ebay.com/b/Collectibles/1/bn_1858810",
                    txt: "Collectibles"
                }, {
                    sp: "m570.l3637",
                    url: "https://web.archive.org/web/20210101121235/https://www.ebay.com/b/Coins-Paper-Money/11116/bn_1857806",
                    txt: "Coins & paper money"
                }, {
                    sp: "m570.l3636",
                    url: "https://web.archive.org/web/20210101121235/https://www.ebay.com/b/Antiques/20081/bn_1851017",
                    txt: "Antiques"
                }, {
                    sp: "m570.l3639",
                    url: "https://web.archive.org/web/20210101121235/https://www.ebay.com/b/Sports-Memorabilia-Fan-Shop-Sports-Cards/64482/bn_1857919",
                ...
                parent: {
                    ...
                    sp: "m570.l3413",
                    url: "https://web.archive.org/web/20210101121235/https://www.ebay.com/b/Electronics/bn_7000259124",
                    txt: "Electronics"
                },
                children: [{
                    sp: "m570.l3653",
                    url: "https://web.archive.org/web/20210101121235/https://www.ebay.com/b/Computers-Tablets-Network-Hardware/58058/bn_1865247",
                    txt: "Computers & tablets"
                }, {
                    sp: "m570.l3654",
                    url: "https://web.archive.org/web/20210101121235/https://www.ebay.com/b/Cameras-Photo/625/bn_1865546",
                    txt: "Cameras & photo"
                }, {
                    sp: "m570.l3655",
                    url: "https://web.archive.org/web/20210101121235/https://www.ebay.com/b/TV-Video-Home-Audio-Electronics/32852/bn_1648392",
                    txt: "TV, audio & surveillance"
                }, {
                    sp: "m570.l3652",
                    url: "https://web.archive.org/web/20210101121235/https://www.ebay.com/b/Cell-Phones-Smart-Watches-Accessories/15032/bn_1865441",
                    txt: "Cell phones & accessories"
                }]
            }, {
                parent: {
                    sp: "m570.l3649",
                    url: "https://web.archive.org/web/20210101121235/https://www.ebay.com/b/Entertainment-Memorabilia/45100/bn_1859756",
                    txt: "Entertainment memorabilia"
                },
                children: [{
                    sp: "m570.l3275",
                    url: "https://web.archive.org/web/20210101121235/https://www.ebay.com/b/Video-Games-Consoles/1249/bn_1850232",
                    txt: "Video games & consoles"
                }, {
                    sp: "m570.l3771",
                    url: "https://web.archive.org/web/20210101121235/https://www.ebay.com/b/Music/bn_7000710860",
                    txt: "Music"
                }, {
                    sp: "m570.l4133",
                    url: "https://web.archive.org/web/20210101121235/https://www.ebay.com/b/DVDs-Blu-ray-Discs/617/bn_223828",
                    txt: "DVDs & movies"
                }, {
                    sp: "m570.l3274",
                    url: "https://web.archive.org/web/20210101121235/https://www.ebay.com/b/Tickets-Experiences/1305/bn_1861080",
                    txt: "Tickets & experiences"
                }]
            }, {
                parent: {
                    title: "Your new destination for Clothing, Shoes &amp; Accessories on eBay",
                    sp: "m570.l3409",
                    url: "https://web.archive.org/web/20210101121235/https://www.ebay.com/b/Fashion/bn_7000259856",
                    txt: "Fashion"
                },
                children: [{
                    sp: "m570.l3632",
                    url: "https://web.archive.org/web/20210101121235/https://www.ebay.com/b/Womens-Clothing/15724/bn_661783",
                    txt: "Women"
                }, {
                    sp: "m570.l3633",
                    url: "https://web.archive.org/web/20210101121235/https://www.ebay.com/b/Mens-Clothing/1059/bn_696958",
                    txt: "Men"
                }, {
                    sp: "m570.l3634",
                    url: "https://web.archive.org/web/20210101121235/https://www.ebay.com/b/Watches/260325/bn_7117208191",
                    txt: "Watches"
                }, {
                    sp: "m570.l3635",
                    url: "https://web.archive.org/web/20210101121235/https://www.ebay.com/b/Mens-Collectible-Sneakers/bn_7000259435",
                    txt: "Sneakers"
                }]
            }, {
                parent: {
                    sp: "m570.l3412",
                    url: "https://web.archive.org/web/20210101121235/https://www.ebay.com/b/Home-Garden/11700/bn_1853126",
                    txt: "Home &amp; garden"
                },
                children: [{
                    sp: "m570.l3646",
                    url: "https://web.archive.org/web/20210101121235/https://www.ebay.com/b/Yard-Garden-Outdoor-Living-Items/159912/bn_1853607",
                    txt: "Yard, garden &amp; outdoor"
                }, {
                    sp: "m570.l3647",
                    url: "https://web.archive.org/web/20210101121235/https://www.ebay.com/b/Art-Craft-Supplies/14339/bn_1851051",
                    txt: "Crafts"
                }, {
                    sp: "m570.l4131",
                    url: "https://web.archive.org/web/20210101121235/https://www.ebay.com/b/Home-Improvement/159907/bn_1851980",
                    txt: "Home improvement"
                }, {
                    sp: "m570.l3773",
                    url: "https://web.archive.org/web/20210101121235/https://www.ebay.com/b/Pet-Supplies/1281/bn_1853597",
                    txt: "Pet supplies"
                }]
            }, {
                parent: {
                    ...
                    sp: "m570.l3411",
                    url: "https://web.archive.org/web/20210101121235/https://www.ebay.com/b/Auto-Parts-and-Vehicles/6000/bn_1865334",
                    txt: "Motors"
                },
                children: [{
                    sp: "m570.l3640",
                    url: "https://web.archive.org/web/20210101121235/https://www.ebay.com/b/Auto-Parts-Accessories/6028/bn_569479",
                    txt: "Parts & accessories"
                },
                    {
                        sp: "m570.l3641",
                        url: "https://web.archive.org/web/20210101121235/https://www.ebay.com/b/Cars-Trucks/6001/bn_1865117",
                        txt: "Cars & trucks"
                    }, {
                        sp: "m570.l3642",
                        url: "https://web.archive.org/web/20210101121235/https://www.ebay.com/b/Motorcycles/6024/bn_1865434",
                        txt: "Motorcycles"
                    }, {
                        sp: "m570.l3643",
                        url: "https://web.archive.org/web/20210101121235/https://www.ebay.com/b/Other-Vehicles-Trailers/6038/bn_1865426",
                        txt: "Other vehicles"
                    }]
            }, {
                parent: {
                    sp: "m570.l3414",
                    url: "https://web.archive.org/web/20210101121235/https://www.ebay.com/b/Sporting-Goods/888/bn_1865031",
                    txt: "Sporting goods"
                },
                children: [{
                    sp: "m570.l3648",
                    url: "https://web.archive.org/web/20210101121235/https://www.ebay.com/b/Outdoor-Sports/159043/bn_1855398",
                    txt: "Outdoor sports"
                },
                    {
                        sp: "m570.l4135",
                        url: "https://web.archive.org/web/20210101121235/https://www.ebay.com/b/Team-Sports/159049/bn_1865097",
                        txt: "Team sports"
                    }, {
                        sp: "m570.l3650",
                        url: "https://web.archive.org/web/20210101121235/https://www.ebay.com/b/Fitness-Running-Yoga-Equipment/15273/bn_1855426",
                        txt: "Exercise & fitness"
                    }, {
                        sp: "m570.l3651",
                        url: "https://web.archive.org/web/20210101121235/https://www.ebay.com/b/Golf-Equipment/1513/bn_1849088",
                        txt: "Golf"
                    }]
            }, {
                parent: {
                    sp: "m570.l3645",
                    url: "https://web.archive.org/web/20210101121235/https://www.ebay.com/b/Toys-Hobbies/220/bn_1865497",
                    txt: "Toys & hobbies"
                },
                children: [{
                    sp: "m570.l4184",
                    url: "https://web.archive.org/web/20210101121235/https://www.ebay.com/b/Trading-Cards/bn_7116496578",
                    txt: "Trading Cards"
                },
                    {
                        sp: "m570.l4185",
                        url: "https://web.archive.org/web/20210101121235/https://www.ebay.com/b/Kids-Toys-Hobbies/220/bn_80740459",
                        txt: "Kids toys"
                    }, {
                        sp: "m570.l1615",
                        url: "https://web.archive.org/web/20210101121235/https://www.ebay.com/b/Action-Figures/246/bn_1648288",
                        txt: "Action figures"
                    }, {
                        sp: "m570.l4186",
                        url: "https://web.archive.org/web/20210101121235/https://www.ebay.com/b/Dolls-Teddy-Bears/237/bn_1865477",
                        txt: "Dolls & bears"
                    }]
            }, {
                parent: {
                    sp: "m570.l3416",
                    url: "https://web.archive.org/web/20210101121235/https://www.ebay.com/n/all-categories",
                    txt: "Other categories"
                },
                children: [{
                    sp: "m570.l3417",
                    url: "https://web.archive.org/web/20210101121235/https://www.ebay.com/b/Gift-Cards-Coupons/172008/bn_1858592",
                    txt: "Gift Cards"
                },
                    {
                        sp: "m570.l3420",
                        url: "https://web.archive.org/web/20210101121235/https://www.ebay.com/b/Health-Beauty/26395/bn_1865479",
                        txt: "Health & beauty"
                    }, {
                        sp: "m570.l3772",
                        url: "https://web.archive.org/web/20210101121235/https://www.ebay.com/b/Musical-Instruments-Gear/619/bn_1865601",
                        txt: "Musical instruments & gear"
                    }, {
                        sp: "m570.l3768",
                        url: "https://web.archive.org/web/20210101121235/https://www.ebay.com/b/Business-Industrial/12576/bn_1853744",
                ...
                parent: {
                    id: "gh-shop-by-brand",
                    sp: "m570.l45017",
                    url: "https://web.archive.org/web/20210101121235/https://www.ebay.com/n/all-brands",
                    txt: "All Brands"
                }, children: []
            }, {
                parent: {
                ...
                parent: {
                    id: "gh-shop-by-sale",
                    sp: "m570.l3601",
                    url: "https://web.archive.org/web/20210101121235/https://www.ebay.com/b/Seasonal-Sales-Events/bn_7109722923",
    ...
    (function (a) {
        GH.add("CategorySelect", function () {
            var b;
            return {
                controlID: "#gh-cat", init: function () {
                    var c = this;
                    b = this;
                    ...
                    GH.Events.publish("stores", {formID: "gh-f", dropDownID: "gh-cat"});
                    GH.Events.subscribe("stores", function (a) {
                        return a
                    })
                }, buildCatSelect: function () {
                    var c, f, d, g = [], e = b.controlID, h = GH.C.selectedCatId || GH.C.catId || 0;
    ...
    GH.getCategories = function () {
        return [{i: 20081, v: "Antiques"}, {i: 550, v: "Art"}, {i: 2984, v: "Baby"}, {i: 267, v: "Books"}, {
            i: 12576,
            v: "Business & Industrial"
        }, {i: 625, v: "Cameras & Photo"}, {i: 15032, v: "Cell Phones & Accessories"}, {
            i: 11450,
            v: "Clothing, Shoes & Accessories"
        }, {i: 11116, v: "Coins & Paper Money"}, {i: 1, v: "Collectibles"}, {
            i: 58058,
            v: "Computers/Tablets & Networking"
        }, {i: 293, v: "Consumer Electronics"}, {i: 14339, v: "Crafts"}, {i: 237, v: "Dolls & Bears"}, {
            i: 11232,
            v: "DVDs & Movies"
        }, {i: 6E3, v: "eBay Motors"}, {
            i: 45100,
            v: "Entertainment Memorabilia"
        }, {i: 172008, v: "Gift Cards & Coupons"}, {i: 26395, v: "Health & Beauty"}, {
            i: 11700,
            v: "Home & Garden"
        }, {i: 281, v: "Jewelry & Watches"}, {i: 11233, v: "Music"}, {
            i: 619,
            v: "Musical Instruments & Gear"
        }, {i: 1281, v: "Pet Supplies"}, {i: 870, v: "Pottery & Glass"}, {i: 10542, v: "Real Estate"}, {
            i: 316,
            v: "Specialty Services"
        }, {i: 888, v: "Sporting Goods"}, {i: 64482, v: "Sports Mem, Cards & Fan Shop"}, {
            i: 260,
            v: "Stamps"
        }, {i: 1305, v: "Tickets & Experiences"}, {i: 220, v: "Toys & Hobbies"}, {i: 3252, v: "Travel"}, {
            i: 1249,
            v: "Video Games & Consoles"
        }, {i: 99, v: "Everything Else"}]
    };
    ebayContent["GlobalHeaderWeb/GreetingsJavascriptContent"] = {
        greetingDefault: 'Hi! <a href="https://web.archive.org/web/20210101121235/https://signin.ebay.com/ws/eBayISAPI.dll?SignIn&amp;ru=ru" _sp="m570.l1524">Sign in</a>\u00a0<span>or <a href="https://web.archive.org/web/20210101121235/https://reg.ebay.com/reg/PartialReg?ru=ru2" _sp="m570.l2621">register</a></span>',
        greetingRecognized: 'Hi <b>${username}</b> (<a href="https://web.archive.org/web/20210101121235/https://signin.ebay.com/ws/eBayISAPI.dll?SignIn&amp;ru=ru" _sp="m570.l2620">Sign in</a>)',
        greetingAuthenticated: "Hi <b>${username}</b>!",
        greetingOverlaySignout: '<a href="https://web.archive.org/web/20210101121235/https://signin.ebay.com/ws/eBayISAPI.dll?SignIn&amp;lgout=1" _sp="m570.l2622">Sign out</a>',
        profile_mycollections: '<a href="https://web.archive.org/web/20210101121235/http://www.ebay.com/cln/_mycollections">My Collections</a>',
        profile_accountsettings: '<a href="https://web.archive.org/web/20210101121235/https://my.ebay.com/ws/eBayISAPI.dll?MyEbay&amp;CurrentPage=MyeBayMyAccounts">Account settings</a>',
        profile_myworld: '<a href="https://web.archive.org/web/20210101121235/https://www.ebay.com/usr/@@">@#@</a>',
        profile_feedback: '<a title="Feedback score" href="https://web.archive.org/web/20210101121235/https://feedback.ebay.com/ws/eBayISAPI.dll?ViewFeedback2&amp;userid=@@"></a>',
        profile_loginUserL10n: '<a href="https://web.archive.org/web/20210101121235/https://signin.ebay.com/ws/eBayISAPI.dll?SignIn&amp;ru=ru">Sign in</a> to see your user information',
        ...
        profile_feedbackscore: '<a href="https://web.archive.org/web/20210101121235/http://my.ebay.com/ws/eBayISAPI.dll?GetGHNotificationsCommand&amp;ghud=1"></a>',
        profile_feedbackscore_new: '<a href="https://web.archive.org/web/20210101121235/http://gha.ebay.com/nproxy/notification/v1/getMinProfile"></a>',
    ...
    (function (b) {
        GH.add("Greeting", function () {
            var m = b.extend(GH.Util.getBundle("GreetingsJavascriptContent"), GH.Util.getBundle("HiddenFromL10NTeamContent")),
                n = GH.undefinedStr, o = GH.new_user_profile;
            return {
                init: function () {
                    var c = this, a, e, d = m.greetingDefault, f, g, i, j, h = GH.vCJar,
                    ...
                    try {
                        ...
                        e =
                            decodeURIComponent(unescape(e))
                    }
                    e = e.replace(/\+/g, " ");
                    typeof e !== n && 0 <= e.indexOf("?") && (e = null);
                    !(0 === GH.C.sin && GH.C.id) && (typeof a !== n && "" !== a && 0 > a.indexOf("@@__@@__@@")) && (d = m.greetingRecognized, GH.userRecog = !0, GH.userID = a, GH.userFN = e, GH.C.cgi || GH.C["static"] ? (f = h.readCookie("dp1", "pcid")) ? (g = i = decodeURIComponent(h.readCookie("cid")), j = g.indexOf("#"), -1 === j && 8 < g.length || (-1 !== j && (i = g.substring(j + 1, g.length)), i === f && (b(window).on("load.gh", function () {
                            h.writeCookie("cid", g, 365)
                        }), GH.userAuth = !0))) :
                        GH.userAuth = !0 : 1 === GH.C.sin && (GH.userAuth = !0), GH.userAuth && (d = m.greetingAuthenticated), !GH.userAuth && ("function" === typeof h.getBitFlag && 1 == h.getBitFlag(h.readCookie("dp1", "pbf"), 98)) && (GH.userRecog = !1, d = m.greetingDefault), a = 77 == GH.C.siteId ? a || e : e || a, 13 < a.length && (a = a.substring(0, 12) + "..."), d = GH.Util.mergeContent(d, {username: GH.Util.eZ(a)}));
                    ...
                    GH.userAuth ? (b("#gh-eb-u").html('<button id=gh-ug class="gh-ua gh-control" aria-expanded=false aria-controls=gh-eb-u-o role=button>' +
                        d + '<b class="gh-eb-arw gh-sprRetina"></b></button><div id="gh-eb-u-o" data-view-state="empty" style="display: none;"></div>'), b("#gh-ug").click(function (a, e) {
                        var d = b("#gh-eb-u").data("mo"), f = b("#gh-eb-u").data("t"), g = (new Date).getTime();
                        b("#gh-eb-u").removeData("mo");
                        if (d || !(f && 400 > g - f)) if (a.preventDefault(), b("#gh-eb-u-o").length && "empty" === b("#gh-eb-u-o").attr("data-view-state")) b("#gh-eb-u-o").remove(), GH.Util.createOverlay("u", 0, e), b("#gh-eb-u-o").data("ghi", 41), GH.Util.openOverlay(b("#gh-ug")),
                            b("#gh-eb-u").addClass("gh-eb-active"), GH.alerts.collectData && GH.Util.cTImg(GH.ghiIMP + 79), o ? (ajaxURL = "/gh/user_profile?modules=USER_PROFILE&behavior=GET_PROFILE&moduleType=USER_PROFILE", "HttpClient" in window && (d = new window.HttpClient(ajaxURL, "GET", {correlation: window.trkCorrelationSessionInfo && "function" === typeof window.trkCorrelationSessionInfo.getTrackingCorrelationSessionInfo && window.trkCorrelationSessionInfo.getTrackingCorrelationSessionInfo()}, null, {
                            shouldRetry: !0,
                            timeout: 1E4
                        }), d.handlers({
                            onload: function (a) {
                                if (a instanceof
                                    ProgressEvent && (a = a.target || a.currentTarget, a instanceof XMLHttpRequest)) try {
                                    var b = JSON.parse(a.responseText), d = c.parseResponse(b);
                                    c.buildGreetingOverlay_nproxy(d, !1, e)
                                } catch (f) {
                                }
                            }, onerror: function () {
                                c.buildGreetingOverlay_nproxy({}, !0, e)
                            }
                        }), d.initializeAndTrigger())) : c.nproxy_ajax(e); else c[b("#gh-eb-u-o").is(":hidden") ? "showUserOverlay" : "hideUserOverlay"](e)
                    ...
                    var a = c && c.content && c.content.response && c.content.response.modules && c.content.response.modules.USER_PROFILE || {},
                        b = {};
                    b.d = a && a.userId && a.userId.textSpans && a.userId.textSpans[0] && a.userId.textSpans[0].text || "";
                    b.p = a && a.image && a.image.URL || "";
                    b.r = a && a.feedbackRating && a.feedbackRating.textSpans && a.feedbackRating.textSpans[1] && a.feedbackRating.textSpans[1].text ||
                        "";
                    b.u = a && a.fullName && a.fullName.textSpans && a.fullName.textSpans[0] && a.fullName.textSpans[0].text || "";
                    c && (c.error && "auth_required" === c.error) && (b.error = "auth_required");
                    return b
                }, nproxy_ajax: function (c) {
                    var a = this,
                        e = GH.Util.getSecURL(GH.Util.getHref(GH.GHSW.newprofile || GH.GHSW.desktop_new_profile_service ? m.profile_feedbackscore_new : m.profile_feedbackscore));
                    b.ajax(e, {
                        dataType: "jsonp", jsonpCallback: "GH_alertData", timeout: 4E3, success: function (b) {
                            a.buildGreetingOverlay_nproxy(b, !1, c)
                        }, error: function () {
                            a.buildGreetingOverlay_nproxy({},
                                !0, c)
                        }
                    })
                }, showUserOverlay: function (c) {
                    var a = b("#gh-eb-u-o").data("ghi");
                    GH.Util.hideOverlays();
                    GH.Util.openOverlay(b("#gh-ug"));
                    b("#gh-eb-u").addClass("gh-eb-active");
                    c && b("#gh-ui a:first").focus();
                    a && GH.Util.cTImg(GH.ghiIMP + a)
                }, hideUserOverlay: function () {
                    GH.Util.closeOverlay(b("#gh-ug"));
                    b("#gh-eb-u").removeClass("gh-eb-active")
                }, buildGreetingOverlay_nproxy: function (c, a, e) {
                    var d = GH.Util.getBundle("GreetingsJavascriptContent"), f, g = b("#gh-eb-u-o"), i = 12, j, h,
                        l = GH.userID, k = GH.userFN;
                    typeof c === n && GH.userAuth &&
                    (c = {});
                    typeof c === n && !a || c && c.error && "auth_required" === c.error ? (f = "<div class=gh-o-err><span class=gh-o-errb>" + d.profile_loginUserL10n.replace(/&amp;ru=ru/g, "&ru=" + GH.Util.addRU()) + "</span></div>", g.data("ghi", 40), g.html(f)) : (j = c.r || 0, b.each([10, 50, 100, 500, 1E3, 5E3, 1E4, 25E3, 5E4, 1E5, 5E5, 1E6], function (a, b) {
                        if (j < b) return i = a, !1
                    }), f = c.p ? c.p.replace(/http:.*pics\//, GH.pi) : GH.pi + "social/profile_avatar_60x60.png", h = 77 == GH.C.siteId ? l || k : k || l, f = "<ul id=gh-uu><li id=gh-up><a aria-hidden=true tabindex=-1 _sp=m570.l3331 href='" +
                        GH.Util.getHref(d.profile_myworld).replace("@@", c.d || l) + "'><img id=gh-upi src='" + f + "' alt='" + d.profile_userAltTxt + h + "'></a></li>", f += "<li id=gh-un>" + (c.u || k || "&nbsp;") + "</li><li id=gh-ui>", k = d.profile_myworld.replace('@@"', (c.d || l) + '"_sp=m570.l3332 id="gh-uid"'), k = k.replace("@#@", "<i class=gh-ar-hdn>" + d.profile_memberAltTxt + "</i> " + l), f += k + (!a && GH.userAuth && "undefined" !== typeof c.r ? " (" + d.profile_feedback.replace('@@"', '"_sp=m570.l3333') + ")" : "") + "</li>", f += "<li id=gh-uac>" + d.profile_accountsettings.replace("href=",
                        "_sp=m570.l3399 href=") + "</li><li id=gh-uo>" + (GH.userAuth ? d.greetingOverlaySignout : d.greetingRecognized.replace(/.*(<a.*a>).*/, "$1").replace(/&amp;ru=ru/g, "&ru=" + GH.Util.addRU())) + "</li></ul>", g.data("ghi", a ? 41 : 39), a && g.addClass("gh-eb-o-err"), g.html(f), e && setTimeout(function () {
                        b("#gh-ui a:first").focus()
                    }, 50), f = b("#gh-uu a[_sp='m570.l3333']").html("<span class='gh-ar-hdn'>" + GH.Util.mergeContent(d.feedbackTitle, {feedback: ""}) + "</span>" + j + (0 < i ? "<i id=gh-ur role=img style='background-position:" + -[-3,
                        16, 35, 54, 73, 92, 113, 135, 157, 179, 201, 224][i - 1] + "px " + (7 > i ? "-1px; margin:0 -4px 0 -2px;" : "-2px;") + "' />" : "")).attr("title", GH.Util.mergeContent(d.feedbackTitle, {feedback: j})), b("#gh-ur").attr("aria-label", d["rating_" + i]), f.attr("href", f.attr("href") + (c.d || l)));
    ...
    (function (e) {
        window.GHFlyout = function (j, i, k) {
            var f = document;
            this.init = function () {
                this.isClick = !1;
                this.ajaxURL = j;
                "" !== i && (this.isClick = !0);
                var a = this.triggerId = this.isClick ? i : k;
                this.isMiniCart = isMiniCart = "gh-minicart-hover" === this.triggerId;
                if (!isMiniCart || !this.detectTouchscreen()) this.triggerElement = f.getElementById(this.triggerId), this.keyboardTriggerElement = this.triggerElement.getElementsByClassName("gh-acc-exp-a"), this.isClick && (this.triggerElement = (this.clickTrigger = this.triggerElement) && this.triggerElement.getElementsByClassName("gh-eb-li-a")[0]),
                0 < this.keyboardTriggerElement.length && (this.keyboardTriggerElement = this.keyboardTriggerElement[0]), this.ghEyebrowBarElement = document.getElementById("gh-top"), this.flyoutContent = null, this.maskId = a + "-mask", a && (this.flyoutElement = f.getElementById(a + "-flyout"), this.flyoutMaskElement = this.addMaskLayer(this.maskId), this.flyoutCloseElement = f.getElementById(a + "-close"), this.flyoutBodyElement = f.getElementById(a + "-body")), this.hidefn = this.hideFlyout.bind(this), this.showfn = this.showFlyout.bind(this), this.renderType =
                    isMiniCart ? "minicart" : "rvi", this.addEvents()
            };
            this.addEvents = function () {
                this.flyoutCloseElement.addEventListener("click", this.hideFlyout.bind(this), !1);
                ...
                window.addEventListener("resize", this.positionFlyout.bind(this),
                    !1);
            ...
            this.addRemoveMouseEvents = function (a) {
                a ? (this.flyoutMaskElement.addEventListener("mouseover",
                    this.hidefn, !1), this.triggerElement.addEventListener("mouseout", this.hidefn, !1), this.flyoutElement.addEventListener("mouseover", this.showfn, !1), this.flyoutElement.addEventListener("mouseout", this.hidefn, !1), this.isClick || this.triggerElement.addEventListener("mouseover", this.showfn, !1)) : (this.flyoutMaskElement.removeEventListener("mouseover", this.hidefn, !1), this.triggerElement.removeEventListener("mouseout", this.hidefn, !1), this.flyoutElement.removeEventListener("mouseover", this.showfn, !1), this.flyoutElement.removeEventListener("mouseout",
                    this.hidefn, !1), this.isClick || this.triggerElement.removeEventListener("mouseover", this.showfn, !1))
            };
            ...
            this.showFlyout = function (a) {
                ...
                if (this.isClick && (a.preventDefault(),
                ...
                a.target.id === this.maskId ? (this.hideFlyout(), a && a.stopPropagation()) : this.showTimeOut = setTimeout(function () {
                    if (b.ghEyebrowBarElement) {
                        var a = b.ghEyebrowBarElement.getBoundingClientRect().bottom;
                        b.flyoutMaskElement.style.top = a + "px"
                    }
                    b.loadStart = Date.now();
                    b.showHideFlyout.call(b, !0)
                }, 150)
            };
            this.durationTimer = null;
            this.triggerShowHideTracking = function (a) {
                var b = a ? "data-show-track" :
                    "data-hide-track", c = null;
                a ? this.durationTimer = Date.now() : this.durationTimer && (c = Date.now() - this.durationTimer, this.durationTimer = null);
                b = this.flyoutBodyElement && this.flyoutBodyElement.getElementsByTagName("div") && this.flyoutBodyElement.getElementsByTagName("div")[0] && this.flyoutBodyElement.getElementsByTagName("div")[0].firstElementChild && this.flyoutBodyElement.getElementsByTagName("div")[0].firstElementChild.getAttribute(b);
                if (c && b && !a) {
                    b = b.replace("dur:", "dur:" + c);
                    try {
                        if ((b = JSON.parse(b)) && b.eventProperty &&
                            b.eventProperty.moduledtl) b.eventProperty.moduledtl = b.eventProperty.moduledtl + "|loadDur:" + this.loadEndTimeStamp, b = JSON.stringify(b)
                    } catch (d) {
                        console.debug("tracking data parse errored")
                    }
                }
                if ("string" === typeof b) try {
                    b = JSON.parse(b), b.actionKind && (b = [b, {actionKind: b.actionKind}]), e(document).trigger("pulsar", b)
                } catch (g) {
                }
            };
            this.showHideFlyout = function (a) {
                var b = e(this.triggerElement), b = this.isClick ? e(this.clickTrigger) : b,
                    c = b.hasClass("gh-flyout-active");
                if (!a ? c : !c) this.flyoutContent || (this.flyoutElement.style.display =
                    "block", this.positionFlyout(), this.getFlyoutContent()), this.keyboardTriggerElement.setAttribute("aria-expanded", a.toString()), a ? b.addClass("gh-flyout-active") : b.removeClass("gh-flyout-active"), this.triggerShowHideTracking(a)
            };
            ...
            this.hideFlyout = function (a) {
                var b = a && a.toElement;
                null === b && (b = document.activeElement);
                if (this.isWithinFlyoutDOM(b, this.triggerId + "-flyout") && a && "keydown" !== a.type) a &&
                a.stopPropagation(), clearTimeout(this.hideTimeOut); else {
                    var c = this;
                    if (a && "keydown" == a.type) {
            ...
            this.getFlyoutContent = function () {
                ...
                if ("HttpClient" in window) {
                    var b = new window.HttpClient(a.ajaxURL, "GET", {correlation: window.trkCorrelationSessionInfo && "function" === typeof window.trkCorrelationSessionInfo.getTrackingCorrelationSessionInfo && window.trkCorrelationSessionInfo.getTrackingCorrelationSessionInfo()}, null, {
                        shouldRetry: !1,
                        timeout: 5E3
                    });
                    b.handlers({
                        onload: function (b) {
                            if (b instanceof ProgressEvent && (b = b.target || b.currentTarget, b instanceof XMLHttpRequest)) try {
                                ...
                                void 0 === d.html || d.error && "auth_required" == d.error ? ("minicart" === a.renderType && d.error && "auth_required" == d.error && window.GH && window.GH.resetCart && window.GH.resetCart(0), a.paintMinicartError(!0)) : a.paintFlyoutContent(d)
                            } catch (g) {
                            }
                        }, onerror: function () {
                ...
                } else 6 > this.HttpClientRetryCounter &&
                setTimeout(function () {
            ...
            this.paintFlyoutContent = function (a) {
                ...
                "function" === typeof window.markoInitComponents && window.markoInitComponents(a.renderedComponents);
                this.positionFlyout();
                this.loadEndTimeStamp = Date.now() - this.loadStart;
                this.triggerShowHideTracking(!0)
            };
            this.paintMinicartError =
                function (a) {
                    var b = document.querySelector("." + this.triggerId + "-gen-error"), c;
                    b && (b.parentElement && 0 < b.parentElement.children.length) && (c = b.parentElement.children[0]);
                    a && (a = GH.Util.getBundle("GreetingsJavascriptContent"), b.innerHTML = a.profile_loginUserL10n.replace(/&amp;ru=ru/g, "&ru=" + GH.Util.addRU()));
            ...
            this.parseInlineResources = function (a, b) {
                ...
                var g = a.querySelectorAll("script");
                if (g && 0 < g.length) {
                    for (var e = g.length, f = 0; f < e; f++) {
                        var h = g[f];
                        "nb_script" === h.id ? c += " ; " + h.innerHTML : d += " ; " + h.innerHTML
                    }
            ...
            this.keyboardEventHandler = function (a) {
                var b = e(this.flyoutElement), c = this.flyoutCloseElement;
                if (13 === a.keyCode || 32 === a.keyCode || "click" === a.type) this.addRemoveMouseEvents(!1), b.attr("role", "dialog"), document.body.classList.add("gh_flyout_keyboard"),
                    this.flyoutCloseElement.style.display = "block", this.showFlyout(a), c.focus(), e.trapKeyboard(b), a && a.stopPropagation()
            };
            this.positionFlyout = function () {
                ...
                if (this.ghEyebrowBarElement) {
                    ...
                    var c = this.triggerElement.getBoundingClientRect(), d = b.width, b = b.left, e = a.offsetWidth;
    ...
    (function (a) {
        ...
        var d = a('<div tabindex="0" class="keyboard-trap-boundary">'),
            ...
            j = a('<div tabindex="0" class="keyboard-trap-boundary">'), b, k, l;
        d.on("focus", c);
        f.on("focus", c);
        g.on("focus", e);
        h.on("focus", c);
        ...
        a.untrapKeyboard = function () {
            void 0 !== b && (d.detach(), f.detach(), g.detach(), h.detach(), i.detach(), j.detach(), b.off("focusExit"), b.removeClass("keyboard-trap--active"), b.trigger("keyboardUntrap"));
            return b
        }
    })(jQuery, window, document);
    (function (a) {
        var c = {findNegativeTabindex: !0, findPositiveTabindex: !0};
            ...
            return {
                init: function () {
                    ...
                    b("#gh-eb").length && b(".gh-dd").each(function () {
                        var c = this, a = b(c), d = a.find(".gh-submenu"), e = a.find(".gh-control");
                        a.attr("id");
                        var f = a.attr("data-imp"), j, k = a.position().left, l = b("#gh-eb").outerWidth() + 10;
                        ...
                        a.closest("#gh-eb").length && (j = d.outerWidth(), k + j > l && d.css({
                            ...
                            left: "auto"
                                       ...
                                       a) {
                    var d = b(c).find(".gh-submenu"), e = b(c).find(".gh-control"), f;
    ...
    (function (f) {
        GH.add("Coupon", function () {
            var d = GH.Util.getBundle("CouponJavascriptContent"), a = GH.Util,
            ...
            return {
                init: function () {
                    var c = GH.C.userMsgConfig, b, e, a;
    ...
    ebayContent["GlobalHeaderWeb/CouponJavascriptContent"] = {
        ...
        BL10N: '<a href="https://web.archive.org/web/20210101121235/https://my.ebay.com/ws/eBayISAPI.dll?MyEbayBeta&amp;CurrentPage=Rewards&amp;sspagename=ebaybucksheader"></a>',
        BOL10N: '<a href="https://web.archive.org/web/20210101121235/http://my.ebay.com/ws/eBayISAPI.dll?MyEbayBeta&amp;CurrentPage=Rewards&amp;sspagename=ebaybucksheader#b_offer"></a>',
        JL10N: '<a href="https://web.archive.org/web/20210101121235/https://my.ebay.com/ws/eBayISAPI.dll?RewardsIntEnroll&amp;CTASignup=false&amp;ExtLanding=false&amp;ssPageName=ebaybucksheader"></a>',
        CL10N: '<a href="https://web.archive.org/web/20210101121235/https://my.ebay.com/ws/eBayISAPI.dll?MyeBay&amp;CurrentPage=MyeBayIncentives&amp;gbh=1"></a>'
    };
    ebayContent["GlobalHeaderWeb/NotificationsJavascriptContent"] = {
        zeroAlertsL10n: "You're all caught up!",
        loginAlertL10n: 'Please <a href="https://web.archive.org/web/20210101121235/https://signin.ebay.com/ws/eBayISAPI.dll?SignIn&amp;ru=ru" _sp="m570.l2881">sign-in</a> to view notifications.',
        errorAlertL10n: "Notifications are not available at this time",
        alertHeader: "Notifications",
        dataURL: '<a href="https://web.archive.org/web/20210101121235/http://my.ebay.com/ws/eBayISAPI.dll?GetGHNotificationsCommand"></a>',
        clickURL: '<a href="https://web.archive.org/web/20210101121235/http://my.ebay.com/ws/eBayISAPI.dll?SetGHNotificationsReadTSCommand"></a>',
        ...
        proxyURL: '<a href="https://web.archive.org/web/20210101121235/http://gha.ebay.com"></a>',
        latestproxyURL: '<a href="https://web.archive.org/web/20210101121235/http://www.gha.pp.stratus.ebay.com"></a>'
    };
    ebayContent["GlobalHeaderWeb/SYMBAnJavascriptContent"] = {
        ...
        loginAlertL10n: '<a href="https://web.archive.org/web/20210101121235/https://signin.ebay.com/ws/eBayISAPI.dll?SignIn&amp;ru=ru" _sp="m570.l2881">Please <span>sign-in</span> to view notifications.</a>'
    };

    function GHalertConf() {
        var d = function (a) {
                return "undefined" !== typeof this[a]
            }("localStorage") && null !== localStorage ? localStorage : 0, b = GH.Util,
            a = GH.Util.getBundle("NotificationsJavascriptContent"), c = GH.Util.getBundle("SYMBAnJavascriptContent"),
            e = {
                pollingFrequency: {
                ...
                countPolling: 0
            }, c = c.loginAlertL10n || a.loginAlertL10n, c = {
                ...
                hours: a.hours,
                hour: a.hour
            }, f = {d: a.countDownDay, h: a.countDownHour, m: a.countDownMinute, s: a.countDownSecond, e: a.countDownEnded},
            b = {
    ...
    function GHalertServiceConf() {
        ...
        return {
            alertURL: b,
            ajaxProperties: {dataType: "jsonp", jsonp: !1, jsonpCallback: "GH_alertData", cache: !1, timeout: 2500},
            ...
            trackingUserType: {CNTROFFR: {B: 101, S: 102}, COACCPTED: {B: 103, S: 104}, CODECLND: {B: 105, S: 106}},
            STATUS: {NEW: 1, READ: 2, DELETED: 4, 1: "NEW", 2: "READ", 4: "DELETED"},
            countdownType: {},
            secCountDown: 900,
            refreshAllDataFlag: 0,
            updateNewItemHTML: 1,
            ...
            NOTIFTYPE: {notif: "NOTIFICATION", msg: "REMINDER"}
        }
    }

    (function (g) {
        var h = [], d = {ITMWON: "1", COCMPLT: "3", MSGM2MMSGHDR: "6", ITMSHPD: "7"}, e = 0, c = {}, f = 0;
        ...
        GH.alertsGroup = {
            init: function (a) {
                ...
                totalCurrentTypeCount -=
                    c[a].count;
                c[a] = {count: 0, total: 0, notificationId: void 0, isShown: !1, isDeleted: !0, shouldGroup: !1}
                ...
                var b = h[this.getGroupId(a)], a = this.getTotal(a);
                return GH.Util.mergeContent(b, {itemcount: "<span class='ghn-o-g-num'>" + a + "</span>"})
                ...
                g.each(d, function (a, b) {
                    c["" + b] = {
                        count: 0, total: 0, notificationId: void 0,
                        isShown: !1, isDeleted: !1, shouldGroup: !1
                    }
                });
    ...
    function GHalertObjData(e, M) {
        var i = M.Conf, E = function (a) {
                return (void 0 !== a || void 0 !== a.errorMessage) && void 0 !== a.errorMessage && void 0 !== a.errorMessage.error ? a.errorMessage.error : !1
            }, X = i.ajaxUpdateProperties, o = {}, t = GH.alertsGroup, s = i.alertURL, C = void 0, m = i.undefinedStr,
            v = i.STATUS, Y = i.NOTIFTYPE, x = M.Util, F = 0, Z = i.tracking, j = {}, $ = i.countdownType, G = -1,
            n = "", d = void 0, y = !1, N = !1, O = -1, H = function (a) {
                ...
                var b = 0, c = function (a) {
                    ...
                    b++;
                    f()
                }, l = e.extend(X, {success: c, error: g}), f = function () {
                    b < i.retryAjaxUpdate && e.ajax(a, l)
                };
                return {put: f, successCB: c, errorCB: g}
            }, A, B = !1, Q = function (a, b) {
                B = !1;
                d = void 0;
                y = !1;
        ...
        var R = function (a, b) {
                ...
                var c;
                if (void 0 === a.notifications) if (void 0 === a.errorMessage && void 0 !== a.d) a.notifications = a.d; else return;
        ...
        return {
            ...
            createOverlyHtml: function (a, b, c) {
                var g, l = a.length, f, e = x.getCurrentTime(), h = "";
            ...
            getParamMap: function (a, b, c) {
                var g = !1, l = GH.Util.isTouchDevice(), f = "", k = "&transactionId", c = p(a), h = c + "l",
                    d = c + "lp", j = "", q = "ghn-cd", n = "MSGM2MMSGHDR" === p(a) ? !0 : !1, s, r;
                r = "";
                ...
                typeof $[p(a)] !== m && !c && (r = U(a), void 0 !== r && (j = x.getTimeDiff(r, b), j === x.tlf.e ? (r = x.tlf.e, j = "<div class='ghn-cd-div'><span  class='" + (q + " ghn-cd-end") + "'>" + r + "</span></div>") : (b = "<span class='ghn-acc-txt'>" + i.messageAlertL10N.timer + "</span>", r = "<span class='ghn-cd-sub0' aria-hidden='true'>" +
                    j.t0 + "</span><span class='ghn-acc-txt ghn-cd-sub1'>" + j.t1 + "</span>", j = "<div class='ghn-cd-div'>" + GH.Util.mergeContent(b, {timeleft: "<span  class='" + q + "'>" + r + "</span>"}) + "</div>")));
            ...
            getObjectValue: function (a, b, c) {
                var c = "undefined" !== typeof c ? c : "content", a = a.find(function (a) {
                    return a.name === b
                }), g = "";
            ...
            addScrollEvent: function (a, b) {
                i.enablePagination && void 0 !== d && (y = !0, e(a).on("scroll.ghn-pagination", function () {
                    var c = e(a), g = c[0].scrollHeight - c.scrollTop() - c.height(),
    ...
    function GHalertObj(f, Ua, Va) {
        var c = f.jQ, O = Va(Ua, c), g = GHalertObjData(c, O), qa = g.isNewDataValid, Fa = g.setNextURL,
            G = g.getNextURL, Wa = g.getItemKey, x = g.getUniqueId, Ga = g.getItemId, Ha = g.getItemEndTime,
            Xa = g.isDuplicate, ra = g.setItemStatus, sa = g.isNewOrPopUp, P = g.loadMoreNotifs, Ya = g.getItemKeyName,
            Q, B, t, Ia, j = null, ca = "", da = "", C = null, R = null, Ja = null, H = 0, Za = O.Const, m = g.conf,
            $a = m.GHlocalStorage, o = m.undefinedStr, n = O.Util, p = O.Tracking(m, g), ab = O.Storage, bb = Za.TITLE,
            ta = m.newalertsasync, ea = m.design, u = {
                size: 115, startPosition: c("#gh").outerHeight(),
                position: c("#gh").outerHeight(), count: 0
            }, S = m.lastMinuteNotif, cb = m.countdownType, Ka = m.secCountDown, T = m.STATUS, y = m.messageAlertL10N,
            db = void 0 !== m.tlf.e ? m.tlf : void 0,
            fa = {2: f.Util.addSignin(y.loginAlertL10n), 4: y.zeroAlertsL10n, 6: y.errorAlertL10n, 3: y.errorAlertL10n},
            I = m.alertURL, ua = "0", ga = m.refreshAllDataFlag, d = m.polling, va = d.secWaitActivity, ha = {},
            e = null, U = [], k = null, wa = null, V = 0, r = {}, ia = {}, w = !1, xa = !1, W = !1, ja = null, s = null,
            D = {}, J = {}, La, q = 0, X = -1, K = -1, ya = !1, Y = !1, ka = !1,
            eb = void 0 !== y.survey ? y.survey : "", Ma = f.GHN_SURVEY_HTML ?
                f.Util.addPrefixPoolURL(f.GHN_SURVEY_HTML.replace("#DESIGN#", "2" === ea ? "Priority" : "Recency").replace("#SVTXT#", eb)) : "",
            E = !~~(100 * Math.random()), Na = typeof JSON === o ? 0 : m.enableLocalStorage,
            i = $a && n.isLocalStorageSupported && Na ? ab : null, Z = !1, A = function (a) {
                typeof a !== o ? ha = setTimeout(L, 1E3 * a) : (a = 30, ya || (a = la(), 0 <= a && (ha = setTimeout(L, 1E3 * a))))
            }, L = function () {
                var a = 103;
                if (w) if (Ja()) A(3); else {
                    E && (d.zeroFlag ? a = 104 : d.activeFlag ? d.bidFlag && (a = 102) : a = 101, f.userAuth && (a += 10), f.Util.cTImg(f.ghiIMP + a));
                    d.countPolling++;
                    if (0 === d.countPolling % d.intervalRefreshData || ga) if (void 0 === ga || ga) X = -1, ua = "1";
                ...
                var a = 30, b = typeof d !== o ? d.pollingFrequency : 0;
                ...
                b = n.getCurrentTime();
                var c;
                typeof cb[Wa(a)] !== o && (b = Ha(a) - b, c = 1E3 * (b - Ka), b >= Ka ? setTimeout(function () {
                    F(function () {
                        Qa(a)
                    })
                }, c) : F(function () {
            ...
            Ra = function (a) {
                var b = "data-id", l = x(a), a = Ga(a);
                C() && (l != a && (b = "data-uid"), c(B + " li[" + b + "=" + l + "] .ghn-cd").addClass("ghn-lm ghn-cd-end").text(n.tlf.e))
            }, Qa = function (a) {
                var b = x(a), l = Ga(a), h = Ha(a);
                typeof r["" + b] !== o && (clearInterval(r["" + b].id), delete r["" + b]);
                n.getTimeDiff(h) == n.tlf.e ? Ra(a) : (g.isBidFlag(a) && (d.bidFlag = !0), r["" + b] = {
                    id: setInterval(function () {
                        var f = n.getTimeDiff(h), e = "data-id", i = "ghn-lm";
                        C() && (b != l && (e = "data-uid"), f == n.tlf.e ? c(B + " li[" + e + "=" + b + "] .ghn-cd").addClass(i + " ghn-cd-end").text(f) :
                            c(B + " li[" + e + "=" + b + "] .ghn-cd").addClass(i).find(".ghn-cd-sub0").text(f.t0).end().find(".ghn-cd-sub1").text(f.t1));
                        if (f == n.tlf.e) if (Ra(a), clearInterval(r["" + b].id), delete r["" + b], c.isEmptyObject(r)) d.bidFlag = !1; else for (e in d.bidFlag = !1, r) if (g.isBidFlag(r[e].item)) {
                            d.bidFlag = !0;
                            break
                        }
                    }, 1E3), item: a
                ...
                "true" !== f.GHSW.NEWALERT_POPUPOFF && g.isPopUp(a) && (c(ca + da).length ? setTimeout(function () {
                    ...
                    var b = a, l = aa(b, 2), l = c("<div class='ghn-pop-wrap'>" +
                        l + "</div>"), h = "#ghn-pop-" + x(b), e = !1, d = !1;
                    f.Util.cTImg(f.ghiIMP + 54 + "&_trkparms=" + p.rowTrack("gh1g", b));
                    0 < c(h).length && c(h).parent().hide("slow").remove();
                    c(ca + da).length ? N() : (c(l).appendTo("body"), c.fn.ghellipsis && c(h + " .ghn-desc-o").ghellipsis({row: 2}), c(l).css({top: u.position + "px"}).animate({right: "0px"}, function () {
                        c(ca + da).length && N()
            ...
            N = function (a) {
                ...
                var b = y.many, l = ("" + a).length, l = 3 < l ? 3 : l;
                c(Q + " i.ghn-num").remove();
                a ? (c(Q + " " + j.ebAClass).append("<i aria-hidden='true' " + (newNotifFlag ? "class='ghn-new ghn-num'" : "class=' ghn-num'") + " id=gh-eb-Alerts-n" + l + ">" + (99 < a ? "99+" : a) + "</i>"), 1 == a && (b = y.one), b = f.Util.mergeContent(b,
                    {itemcount: a})) : (l = 0, b = y.zero);
                c("#gh-Alerts-i").text(b);
                c("#gh-Alerts-i").parent().attr("aria-label", b);
                c(Q).removeClass(" gh-eb-Alerts-tab-0 gh-eb-Alerts-tab-1 gh-eb-Alerts-tab-2 gh-eb-Alerts-tab-3").addClass(" gh-eb-Alerts-tab-" + l)
            }, oa = function (a, b) {
                ...
                q = 0;
                xa = !0;
                if (typeof a === o || void 0 !== a.errorMessage) void 0 !== a && (void 0 !== a.errorMessage && void 0 !== a.errorMessage.error[0]) && (La = a.errorMessage.error[0].errorId), w = !1; else if (d.zeroFlag = g.isZeroFlag(a), e = g.processNotifData(a, e, J), e.length <= H && m.group && "function" === typeof P && void 0 !== G(!0) ? Y = !0 : oa(S, !0), v(!0, !0), w = !0, a = g.getTotalNumNotifs(), void 0 !== a && (q = a), newNotifFlag = q, C() && !R() && z(), !p.dataloadSojDropped && (a = "%26gh1g%3dT" + e.length, a += ".N" + q, a += p.getSojItemsStr())) p.dataloadSojDropped = 1, 0.1 >= Math.random() &&
                f.Util.cTImg(f.ghiIMP + 1 + a);
                $(q)
            }, aa = function (a, b, c, h) {
                var e, d, b = [k.tmpl_i, k.tmpl_g, k.tmpl_p, k.tmpl_cpn][b],
                    b = !h && g.isShowTimeDiff(a) ? b.replace("#H#", k.s0h) : b.replace("#H#", ""),
                    b = h ? b.replace("#BMI#", "<div class='ghn-bmi'></div>") : b.replace("#BMI#", ""),
                    b = b.replace("#rmv#", y.removeNotif), b = b.replace("#newNotif#", y.newNotif);
                d = g.getParamMap(a, c, h);
                for (e in d) {
                    c = d[e];
                    typeof c === o && (c = "");
                    if ("#LINK#" == e || "#LINKP#" == e) "#LINK#" == e && !h && typeof k.iLink !== o && g.isTransactionNotValid(a) ? c = c.replace(/.*(_trksid=.*)/,
                        k.iLink + "&$1") : g.isHubCampaign(a) && (c = g.getActionUrl(a)), c += "&_trkparms=" + p.rowTrack("gh1g", a, h);
                    b = "#ITEMID#" == e || "#DIFF#" == e || "#UID#" == e ? b.replace(RegExp(e, "g"), c) : b.replace(e, c)
                }
                b = b.replace("=m570", "=p" + f.C.pageId + ".m570");
                "1" === ea && (b = b.replace("#P#", ""));
                return b
            }, Ba = function (a, b) {
                var l, h, d, i = "", j = c.isArray(a) ? !1 : !0, m = "%26", o = !1, k = c(t + " li").length;
                s = a;
                if (j) {
                    if (!qa(a)) return;
                ...
                Z = !1;
                h = a.length;
                for (l = 0; l < h; l++) d = !1, newItem = a[l], j && c.each(e,
                    function (a, b) {
                        if (d = Xa(b, newItem, !0)) return !1
                    }), d || (g.isPopUp(newItem) && (newItem = g.setPopupShow(newItem), g.sendSetItemNew(newItem)), j && g.addNewData(e, newItem, !0), !1 !== b && (za(a[l]), i = f.alertsGroup.isItemGroup(newItem.mdnsName) ? i + aa(newItem, 1, void 0, 1) : i + aa(newItem, 0), k++, void 0 === p.notifIdSojDropped[x(newItem)] && (o = !0, m += p.rowTrack("ghn" + k + "r", newItem, !1) + "%26", p.notifIdSojDropped[x(newItem)] = 1)));
                v(!0, !0);
                !1 !== b && (0 < i.length && (c(t).append(i), c.fn.ghellipsis && c(B).is(":visible") && c(".ghn-desc-o").ghellipsis({row: 2}),
                o && (f.Util.cTImg(f.ghiIMP + 5 + m), p.overlayLastIdxSojDropped = k)), c(".ghn-i").each(function (a, b) {
                    n.createImage(b)
                }))
            }, z = function (a) {
                var b = "", l = "%26", h = 0, d = B, b = 0, i = j.overlayTemplate;
                typeof e === o || !1 === w ? 30016 === La ? ba(d, 2) : ba(d, 3) : (b = g.createOverlyHtml(e, aa, function (a, b) {
                    h++;
                    l += p.rowTrack("ghn" + h + "r", a, b) + "%26";
                    p.notifIdSojDropped[x(a)] = 1
                }), l += "ghntnd%3D" + h + "%26", a && e.length < H && (b += "<li class='ghn-o-l'><div class='gh-o-l'></div></li>"), 0 >= b.length ? ba(d, 4) : (b = i.replace("#TEXT#", b).replace("#SURVEY#", Ma),
                    c(d).html(b), U.length && Ba(U), c.fn.ghellipsis && c(d).is(":visible") && c(".ghn-desc-o").ghellipsis({row: 2}), c.fn.ghellipsisDetails && c(d).is(":visible") && c(".ghn-desc__min_details").ghellipsisDetails({row: 2}), b = c(t + " li").length, a = b >= H ? j.overlayHeight : b * j.itemHeight + c(".coupon-itm").length * j.itemLargeHeight + 10 * c(".coupon-itm.coupon-itm__tall").length, c.fn.scrollLock && c(t).css("height", a + "px").scrollLock("ghn"), c(Ia + " .gh-survey").click(f.Util.surveyClicked), c(".ghn-i").each(function (a, b) {
                    n.createImage(b)
                }),
                    c(t).on("scroll.ghn_soj", function () {
                        f.Util.cTImg(f.ghiIMP + 53 + "%26gh1g%3DTR" + c(t + " li.ghn-li-itm").length);
                        c(t).off("scroll.ghn_soj")
                    }), "function" === typeof g.addScrollEvent && g.addScrollEvent(t, Ba), c(d).data("ghi", 5 + l), p.overlaySojDropped || (p.overlaySojDropped = 1, f.Util.cTImg(f.ghiIMP + c(d).data("ghi")))))
            }, pa = function (a, b, e) {
                a <= H && 0 < a && (a = a * j.itemHeight + ("undefined" !== typeof b ? b : 0) * j.itemLargeHeight + 10 * ("undefined" !== typeof e ? e : 0), c(t).animate({height: a + "px"}))
            }, Oa = function (a, b) {
                var f = !1, h, i = !1;
                h = !1;
                var j, k;
                Y = !1;
                s = a;
                if (b || g.isHandleNotifNeedUpdated(a)) if (Pa(), qa(a)) if (g.isZeroData(a) ? (h = !0, b ? v(!1) : v(!0, !1), d.zeroFlag = !0) : d.zeroFlag = !1, a = g.convertItemType(a), b || (Fa(a.next), U = [], void 0 !== G() && (g.getIsScrollEventAdded() || g.addScrollEvent())), void 0 !== g.handleNewNotif && (a = g.handleNewNotif(a, e)), h) C() && !R() && z(); else {
                    e = a;
                    e.length <= H && m.group && "function" === typeof P ? P(a, t, void 0, function (a) {
                        void 0 !== a && (e = a);
                        oa(S, !0);
                    ...
                    Z = !1;
                    j = a.length;
                    for (h = 0; h < j; h++) k = e[h], typeof r["" + x(a[h])] !== o && (1 == S && typeof b === o) && clearInterval(r["" + x(a[h])].id), za(e[h]), Aa(e[h]), sa(k) && (i = f = !0, q++), g.updateBucket(k);
                ...
                k ? (void 0 === n.tlf && (n.tlf = k.tlf), a()) : typeof GH_NOTIFICATION_TMPL !==
                o ? (k = f.Util.addPrefixPoolURL(GH_NOTIFICATION_TMPL), Ca(a)) : wa ? setTimeout(function () {
                    F(a)
                    ...
                    success: function (b) {
                        ...
                        k = c.extend(f.commonAlertTemplate, k);
                        g.setTmplL10N(k);
                        Ca(a)
                    }
                }))
            }, ba = function (a, b, e) {
                var g = e, d = j.errorTemplate;
                typeof e === o && (e = fa[b], g = d.replace("#TEXT#", e), 2 === b && (g = g.replace("ghn-errb", "ghn-errb ghn-errb-a")));
                c(a).data("ghi",
                    b);
                p.overlaySojDropped || (p.overlaySojDropped = 1, f.Util.cTImg(f.ghiIMP + c(a).data("ghi")));
                g = g.replace("#SURVEY#", Ma);
                c(a).html(g);
                a = c("#ghn-err a");
                ...
                var h, i = !1, j = function () {
                    ...
                    W = !1;
                    void 0 !== a && void 0 !== a.ProxyTime && (a.currentTimeDiff =
                        n.getCurrentTime() - ~~(a.ProxyTime / 1E3));
                    X = g.getLastUpdateTimeStamp();
                    K = n.getCurrentTime();
                    M(a);
                    V = 0;
                ...
                null === ja && (null === e && !w && !xa && !W ? V ? setTimeout(function () {
                    ...
                    k(a, b);
                    i = !0
                }, !f.NotificationsMock || !f.NotificationsMock.useMock ? (f.Util.loadScript(I.alertDataURL + "&nb=1"), setTimeout(function () {
                    window.GH_alertDataNB = function () {
                    };
                    i || j()
                }, 2500)) : f.Util.loadScript(f.NotificationsMock.mockDataUrl,
                    !1)) : (h = c.extend(m.ajaxProperties, {
                    success: function (a) {
                        k(a, b)
                    }, error: function () {
                        j()
                    }
                }), ja = c.ajax(I.alertDataURL, h))) : W ? typeof d !== o && d() : b())
            }, Sa = function (a) {
        ...
        return {
            ...
            clickconfirmButton: function (a, b, g) {
                ...
                typeof d !== o && (D[b] = !1, typeof g !== o && (D[b] = Ya(d), f.alertsGroup.deleteGroupItem(d)), e = c.grep(e, function (a) {
            ...
            visibleTab: function () {
                ...
                d.waitTimer = setTimeout(ma, 1E3 * va);
                clearTimeout(ha);
                d.activeFlag ? (null === i ? (0 > a && (a = 0), a = K + a - n.getCurrentTime()) : a = i.timestamp - n.getCurrentTime(), 0 < a ? (i && (b = i.getValue("updatedTimestamp"), b > i.updatedTimestamp && (i.data = i.getValue(),
                    M(i.data), i.updatedTimestamp = b)), A(a)) : L()) : L();
                d.activeFlag = !0
            },
            removePopUp: N,
            removeItem: Sa,
            getDataAndShowOverlay: function () {
                ...
                w && !k ? F(function () {
                    $(q);
                    Y ? (z(!0), ka = !0, P(e, t, void 0, a, pa)) : z();
                    na()
                }) : !w && k ? Ea(!0) : !w && !k ? F(function () {
                    Ea(!0)
                }) : (Y ? (z(!0), ka = !0, P(e, t, void 0, a, pa)) : z(), na())
            },
            getAlertData: L,
            ...
            init: function () {
                ...
                c(Q + " .gh-eb-li-a").bind("click.ghn", function (a) {
                    f.Util.cTImg(f.ghiIMP + (c(B).is(":hidden") ? 87 : 88));
                    a.preventDefault()
                });
                j.addShowEventOnOverlay();
                if (f.userRecog) {
                    typeof i !== o && i && i.init(g.getServiceName());
                    if (null === i) if (ta) a(!0); else c(window).on("load.gh", function () {
                        a(!1)
                    }); else {
                        var b = i.timestamp - n.getCurrentTime();
                        if (0 >= b || f.NotificationsMock) if (ta) a(!0); else c(window).on("load.gh", function () {
                            a(!1)
                        });
                        else {
                            ...
                            if (ta) {
                                var e = n.getCurrentTime() - d, b = b - e;
                                A(b)
    ...
    function GHalertBase() {
        var r = null, n = null, w = GH.Util.getBundle("NotificationsJavascriptContent"), t = GHalertObj,
            q = function (l, h) {
                if (null === r) {
                    var k = function (c) {
                            return "undefined" !== typeof this[c]
                        }("localStorage") && null !== localStorage ? localStorage : 0, o = GHalertConf(),
                        o = h.extend(o, GHalertServiceConf()), p, n = 0, q = function () {
                    ...
                    p = {
                        tlf: null, getTimeDiff: function (c, a) {
                            var b, i = p.tlf, j = {}, m = "", d = "", e = "", d = "", f, g = o.messageAlertL10N;
                            ...
                            j.t1 = d;
                            return j
                        }, sizeCheck: u, sort: function (c, a, b, i) {
                            c = 0 === b ? c - a : a - c;
                            return 0 !== c ? c : i()
                            ...
                            a.onload = u;
                            a.src = h(c).attr("src")
                        }, isLocalStorageSupported: s, getCurrentTime: q
                    };
                    r = {
                        Const: {TITLE: w.alertHeader}, Conf: o, Util: p, Tracking: function (c,
                                                                                             a) {
                            var b = {}, i = c.tracking, j = c.trackingUserType;
                            ...
                            return {
                                ...
                                addTotalByTrackId: function (c, d) {
                                    var e;
                                    e = a.getItemKey(c);
                                    var f = i[e], g = c.buyerNotification;
                                ...
                                rowTrack: function (c, d, b) {
                                    var f = a.getItemKey(d), g = a.getItemGroup(d), h;
                ...
                getCore: q, getAlertObj: function (l, h) {
                    null ===
                    n && (n = t(l, h, q));
                    return n
                }
    ...
    function GHalertDesktop(k, g, h, a) {
        var c = k(a).require("AlertObj", [g, h]), j = g.ghEBActive_id, k = "." + j, i = a("#gh-eb-Alerts"), l = !1,
            m = 0;
        onRemoveNotiifcation = function (b, d) {
            ...
            f = a(e).closest("li");
            if ("none" === a(e).find("i").css("display")) return b.stopPropagation(), b.preventDefault(), f.find("a.ghn-a-itm").trigger(b.type),
                !1;
            if (f.find(".ghn-confirm").length) a(e).closest("li").find(".ghn-a-itm").addClass("disable").end().find(".ghn-desc").hide().end().find(".ghn-confirm").show(); else {
                var d = f.attr("data-uid") || li.attr("data-id"), h = f.attr("data-groupid");
                b.preventDefault();
        ...
        addEventOnOverlay = function () {
            ...
            i.delegate("#gh-eb-Alerts-o a.ghn-a-itm", "click touchend", function (b) {
                var d = a(this).parent(), e = d.attr("data-uid"), f = d.attr("data-id");
                void 0 === e &&
                (e = f);
                b.preventDefault();
        ...
        var h = {addEvent: addEvent}, o = function (b, c) {
            25 < c ? a("#gh-eb-Alerts .gh-control").focus() :
                setTimeout(function () {
                    var e = a("#gh-eb-Alerts-o a:first"), f = a("#ghn-err");
        ...
        return a.extend(c, {
            ...
            openOverlay: function (b, d, e) {
                ...
                a.fn.ghellipsis && (a.fn.ghellipsisDetails && a(d).is(":visible")) && a(".ghn-desc-o").ghellipsis({row: 2});
                a.fn.ghellipsisDetails && a(d).is(":visible") && a(".ghn-desc__min_details ").ghellipsisDetails({row: 2});
                b.addClass(j)
            },
    ...
    (function (f) {
        GH.add("Cart", function () {
            var d = GH.vCJar, a = GH.C.ct, e = f("#gh-cart a"), g = f("#gh-minicart-hover .gh-eb-li-a"),
            ...
            return {
                init: function () {
                    ...
                    if (a.length) {
                        ...
                        c && (c = GH.Util.mergeContent(c, {itemcount: b}), cartObj.attr({title: c, alt: c}));
    ...
    ebayContent["GlobalHeaderWeb/AutocompleteJavascriptContent"] = {
        ...
        acCatalog: '<a href="https://web.archive.org/web/20210101121235/http://www.ebay.com/ctg/?_pid=#P#&amp;_trksid="></a>',
    ...
    (function (a) {
        GH.add("SearchBox_AutoComplete", function () {
            var d;
            return {
                acDisabledClass: "gh-acHidden", init: function (g) {
                    var e = GH.vCJar, h = GH.Util.getBundle("AutocompleteJavascriptContent");
                    d = this;
                    !g && e && 1 == e.getBitFlag(e.readCookie("dp1", "pbf"), 29) ? (a(GH.ghAC_id).after("<a id=ghAC-show class='gh-spr icas' title='" + h.acShowSuggestions + "' href='#'></a>"), a(GH.componentID).addClass(d.acDisabledClass), a(GH.ghAC_id).attr({
                        ...
                        GH.sec && (b = b.replace(/^http:\/\/ir./, "https://web.archive.org/web/20210101121235/https://secureir."));
                        a.ajax(b, {
                            dataType: "jsonp", cache: !0, jsonp: !1, error: function (a) {
    ...
    ebayContent["GlobalHeaderWeb/InflowJSContent"] = {url: '<a href="https://web.archive.org/web/20210101121235/http://ocsrest.ebay.com/ocsrsapp/o2/inflow/inflowcomponent?callback=Inflow.cb"></a>'};
    (function () {
        GH.add("Inflow", function () {
            return {
                init: function () {
                    window.addEventListener("load", function () {
                        var a = document.getElementById("gh-ihelp"), a = null != a ? a.innerHTML : "{}",
                    ...
                    return GH.Inflow.extend(JSON.parse((document.getElementById("inflowparameters") || []).value || "{}"), {
                        pageId: GH.C.pageId,
                        gbhEnabled: a
                    }, a ? {gbhSiteId: parseInt(GH.C.siteId), gbhLanguage: GH.C.lng || ""} : {})
                }, extend: function () {
                    for (var a = 1; a < arguments.length; a++) for (var b in arguments[a]) arguments[a].hasOwnProperty(b) &&
    ...
    GH.getWidgetDeliveryPlatform = function () {
        return {base_path: "/gh", new_buyer_acquistion: "/useracquisition"}
    };
    (function () {
        ...
        GH.add("ScreenDetail", function () {
            ...
            return {
                init: function () {
                    ...
                    var a = document.getElementById("gh-screen"), a = null != a ? c.getJSON(a.innerHTML) : {}, d = {};
                    j.extend(d, {
                        currentResValue: {maxWidth: -1, minWidth: -1, name: "DEFAULT", value: 0, id: 0, integer: 0},
                        resRange: [{
                            minWidth: -1,
                            maxWidth: -1,
                            name: "DEFAULT",
                            ...
                            id: 0,
                            integer: 0
                        }, {minWidth: 0, maxWidth: 1024, name: "RES_1024", value: 1, id: 1, integer: 1}, {
                            minWidth: 1025, maxWidth: 1152, name: "RES_1152", value: 2,
                            id: 2, integer: 2
                        }, {
                            minWidth: 1153,
                            maxWidth: 1280,
                            ...
                            id: 6,
                            integer: 6
                        }, {minWidth: 1681, maxWidth: 2147483647, name: "RES_MAX", value: 7, id: 7, integer: 7}],
                        resBits: [85, 86, 87],
                        cookieName: "dp1",
                        cookieletName: "pbf",
                        ...
                        viewportRange: [{
                            ...
                            id: 4,
                            integer: 4
                        }, {minWidth: 1153, maxWidth: 1276, name: "VIEWPORT_5", value: 5, id: 5, integer: 5}, {
                            minWidth: 1277, maxWidth: 1280, name: "VIEWPORT_6",
                            value: 6, id: 6, integer: 6
                        }, {minWidth: 1281, maxWidth: 2147483647, name: "VIEWPORT_7", value: 7, id: 7, integer: 7}]
                    }, a);
                    return d
                    ...
                    var c = 0;
                    if (d) for (var e = d.length - 1; 0 <= e; e--) if (a >= d[e].minWidth && a <= d[e].maxWidth) {
                        c = d[e].id;
                        break
                    }
                    return c
    ...
    (function () {
        GH.add("ABDETECTION", function () {
            var a;
            return {
                cfg: {}, postDetectionActionsCompleted: !1, init: function () {
                    a = this;
                    ...
                    this.postDetectionActionsCompleted =
                        !0;
                    ...
                    try {
                        a.readCookieValue().toString() !== b.toString() ? (a.writeToCookie(a.cfg.ckbit, b), 0 === b ? a.triggerEvent({state: "JUST_DISABLED"}) : 1 === b && a.triggerEvent({state: "JUST_ENABLED"})) : 1 === b && a.triggerEvent({state: "ALREADY_ENABLED"})
                    } catch (e) {
                    }
                    ...
                    if (GH && GH.vCJar && a) {
                        c = GH.vCJar;
                        var d = c.readCookie("dp1", "pbf"), d = c.setBitFlag(d || "#", a, e || 0);
                        c.writeCookielet("dp1", "pbf", d, "", "")
                    }
                }, triggerEvent: function (a) {
                    "function" === typeof document.dispatchEvent && "function" === typeof window.CustomEvent && document.dispatchEvent(new CustomEvent("GH_ABD_STATUS", {detail: a}))
                }
            }
        })
    })();
    ...
    (function (c) {
        GH.add("PushNotifications", function () {
            return {
                init: function () {
                    if (typeof GH.C.lng === GH.undefinedStr && (typeof GH.C.geoLang === GH.undefinedStr || "[]" == GH.C.geoLang)) {
                        var d = GH.C.qapool ? "https://web.archive.org/web/20210101121235/https://api4.qa.ebay.com/mobile" : "https://web.archive.org/web/20210101121235/https://mobipushpkg.ebay.com/mobile",
                            e = GH.C.qapool ? "https://web.archive.org/web/20210101121235/https://api4.qa.ebay.com/mobile/v1/devices/token/sync/web.com.ebay.site" : "https://web.archive.org/web/20210101121235/https://mobipushpkg.ebay.com/mobile/v1/devices/token/sync/web.com.ebay.site",
                            a = GH.userAuth && window.safari && typeof window.safari.pushNotification !== GH.undefinedStr ?
                                window.safari.pushNotification : 0;
                        GH.webApplePush_CallBack = function () {
                            "function" === typeof GH.Util.cTImg && GH.ghiIMP !== GH.undefinedStr && GH.Util.cTImg(GH.ghiIMP + 118)
                        };
                        GH.webApplePush_MobileSyncSvc = function (b) {
                            var a = {};
                            a.user = GH.userID;
                            a.state = b.permission;
                            c.post(e.replace(/token/, b.deviceToken), JSON.stringify(a), function () {
                            })
                        };
                        GH.webApplePush_checkRemotePermission = function () {
                            var b = a.permission("web.com.ebay.site");
                            "default" === b.permission ? a.requestPermission(d, "web.com.ebay.site", {user: GH.userID}, GH.webApplePush_CallBack) :
                                "granted" === b.permission && 0 == ~~(100 * Math.random()) % 20 && GH.webApplePush_MobileSyncSvc(b)
                        };
                        a && ("function" === typeof a.permission && "function" === typeof a.requestPermission) && setTimeout(GH.webApplePush_checkRemotePermission, 3E3)
                    }
                }
            }
        })
    })(GH.jQ);
    ebayContent["GlobalHeaderWeb/BackToTopJavascriptContent"] = {arrowImage: '<img title="Scroll to top" src="https://web.archive.org/web/20210101121235/http://ir.ebaystatic.com/pictures/aw/pics/globalheader/btt.png" alt="Scroll to top" border="0" height="76" width="33" _id="gh-bti"/>'};
    (function (c) {
        GH.add("BackToTop", function () {
            var a, e = GH.Util.getBundle("BackToTopJavascriptContent");
            return {
                bttWindow: GH.jQ(window), init: function () {
                    a = this;
                    GH.jQ(".sp-tp").remove();
                    ...
                    window.setTimeout(function () {
                            var b = a.bttWindow.scrollTop(), d = 350 < b;
                            if (void 0 !== GH.previousTopPosition && GH.previousTopPosition === b) {
                                if (!GH.$ghbt) {
                                    GH.$ghbt = GH.jQ("<button/>").attr({id: "gh-bt", "class": "gh-hide-if-nocss"});
                                    ...
                                    GH.$ghbt.click(function (a) {
                                        a.preventDefault();
                                        GH.jQ("body,html").animate({scrollTop: 0}, /iPad/i.test(GH.userAgent) ? 0 : 150, function () {
                                            c("#gh-gb").focus()
                                        });
                                        GH.Util.cTImg(GH.ghiIMP + 43)
                                    })
                                }
                                GH.$ghbt.animate({right: d ? -1 : -1 * GH.$ghbt.outerWidth()}, d ? 500 : 50, function () {
                                    if (b === a.bttWindow.scrollTop()) a.bttWindow.on("scroll.gh", a.rerun); else GH.previousTopPosition = a.bttWindow.scrollTop(), a.rerun()
                                })
        ...
        GH.add("PulsarPolyfill", function () {
            return {
                init: function () {
                    function f(c, b) {
                        c = c || {};
                        if ("object" === typeof b) for (var a in b) if (b.hasOwnProperty(a)) {
                            var d = g[a] ? g[a] : a;
                    ...
                    var i = "function" === typeof object && "object" === typeof _plsUBTTQ, h = !1;
                    try {
                    ...
                    var g = {eventAction: "eactn", eventFamily: "efam", operationId: "cp"};
...
/*
     FILE ARCHIVED ON 12:12:35 Jan 01, 2021 AND RETRIEVED FROM THE
...
/*
playback timings (ms):
  captures_list: 271.804
  exclusion.robots: 0.068
  exclusion.robots.policy: 0.058
  cdx.remote: 0.059
  esindex: 0.011
  LoadShardBlock: 225.601 (3)
  PetaboxLoader3.datanode: 77.777 (4)
  PetaboxLoader3.resolve: 194.086 (3)
  load_resource: 68.316
*/
